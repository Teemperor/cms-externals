...
#ifndef FFTJET_ETCENTROIDRECOMBINATIONALG_HH_
...
namespace fftjet {
    ...
    <
        ...
        typename VBuilder
    >
    class EtCentroidRecombinationAlg :
        public KernelRecombinationAlg<Real, VectorLike, BgData, VBuilder>
    {
    public:
        inline EtCentroidRecombinationAlg(ScaleSpaceKernel* kernel,
        ...
        inline virtual ~EtCentroidRecombinationAlg() {}
...
#endif // FFTJET_ETCENTROIDRECOMBINATIONALG_HH_
