...
#ifndef FFTJET_FASTERETSUMRECOMBINATIONALG_HH_
#define FFTJET_FASTERETSUMRECOMBINATIONALG_HH_
...
namespace fftjet {
    ...
    <
        ...
        typename VBuilder
    >
    class FasterEtSumRecombinationAlg :
        public FasterKernelRecombinationAlg<Real, VectorLike, BgData, VBuilder>
    {
    public:
        inline FasterEtSumRecombinationAlg(ScaleSpaceKernel* kernel,
        ...
        inline virtual ~FasterEtSumRecombinationAlg() {}
...
#endif // FFTJET_FASTERETSUMRECOMBINATIONALG_HH_
