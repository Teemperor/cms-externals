c  corrected I3 I4: -1 3 -> SDX, -3 1 -> DSX   on 5.12.2015
C ---------  begin processes initiated by CCbar

      SUBROUTINE  CCX(P,I3,I4,H1,H2,KEY,ANS)
      IMPLICIT NONE
...
C or I3=21 AND I4=21 -> GLUONS AS FINAL JETS
      ...
      IF(KEY.EQ.1) THEN
         IF(I3.EQ.1 .AND. I4.EQ.-1) CALL CCX_DDX_H(P,H1,H2,ANS)
         IF(I3.EQ.2 .AND. I4.EQ.-2) CALL CCX_UUX_H(P,H1,H2,ANS)
         IF(I3.EQ.3 .AND. I4.EQ.-3) CAll CCX_SSX_H(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.-4) CALL CCX_CCX_H(P,H1,H2,ANS)
         IF(I3.EQ.1 .AND. I4.EQ.-3) CALL CCX_DSX_H(P,H1,H2,ANS)
         IF(I3.EQ.3 .AND. I4.EQ.-1) CALL CCX_SDX_H(P,H1,H2,ANS)
         IF(I3.EQ.-1 .AND. I4.EQ.1) CALL CCX_DDX_H(PP,H1,H2,ANS)
         IF(I3.EQ.-2 .AND. I4.EQ.2) CALL CCX_UUX_H(PP,H1,H2,ANS)
         IF(I3.EQ.-3 .AND. I4.EQ.3) CAll CCX_SSX_H(PP,H1,H2,ANS)
         IF(I3.EQ.-4 .AND. I4.EQ.4) CALL CCX_CCX_H(PP,H1,H2,ANS)
         IF(I3.EQ.-3 .AND. I4.EQ.1) CALL CCX_DSX_H(PP,H1,H2,ANS)
         IF(I3.EQ.-1 .AND. I4.EQ.3) CALL CCX_SDX_H(PP,H1,H2,ANS)
            IF(I3.EQ.0 .AND. I4.EQ.0) THEN 
                CALL CCX_DDX_H(P,H1,H2,ANS1)
                CALL CCX_UUX_H(P,H1,H2,ANS2)
                CALL CCX_SSX_H(P,H1,H2,ANS3)
                CALL CCX_CCX_H(P,H1,H2,ANS4)
                CALL CCX_DSX_H(P,H1,H2,ANS5)
                CALL CCX_SDX_H(P,H1,H2,ANS6)
                ANS=ANS1+ANS2+ANS3+ANS4+ANS5+ANS6
                CALL CCX_DDX_H(PP,H1,H2,ANS1)
                CALL CCX_UUX_H(PP,H1,H2,ANS2)
                CALL CCX_SSX_H(PP,H1,H2,ANS3)
                CALL CCX_CCX_H(PP,H1,H2,ANS4)
                CALL CCX_DSX_H(PP,H1,H2,ANS5)
                CALL CCX_SDX_H(PP,H1,H2,ANS6)
                ANS=ANS1+ANS2+ANS3+ANS4+ANS5+ANS6+ANS
            ENDIF
      ELSE IF(KEY.EQ.0) THEN 
         IF(I3.EQ.1 .AND. I4.EQ.-1) CALL CCX_DDX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.2 .AND. I4.EQ.-2) CALL CCX_UUX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.3 .AND. I4.EQ.-3) CAll CCX_SSX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.-4) CALL CCX_CCX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.1 .AND. I4.EQ.-3) CALL CCX_DSX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.3 .AND. I4.EQ.-1) CALL CCX_SDX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.-1 .AND. I4.EQ.1) CALL CCX_DDX_NOH(PP,H1,H2,ANS)
         IF(I3.EQ.-2 .AND. I4.EQ.2) CALL CCX_UUX_NOH(PP,H1,H2,ANS)
         IF(I3.EQ.-3 .AND. I4.EQ.3) CAll CCX_SSX_NOH(PP,H1,H2,ANS)
         IF(I3.EQ.-4 .AND. I4.EQ.4) CALL CCX_CCX_NOH(PP,H1,H2,ANS)
         IF(I3.EQ.-3 .AND. I4.EQ.1) CALL CCX_DSX_NOH(PP,H1,H2,ANS)
         IF(I3.EQ.-1 .AND. I4.EQ.3) CALL CCX_SDX_NOH(PP,H1,H2,ANS)
         IF(I3.EQ.21 .AND. I4.EQ.21) CALL CCX_GG_NOH(P,H1,H2,ANS)
            IF(I3.EQ.0 .AND. I4.EQ.0) THEN 
                CALL CCX_DDX_NOH(P,H1,H2,ANS1)
                CALL CCX_UUX_NOH(P,H1,H2,ANS2)
                CALL CCX_SSX_NOH(P,H1,H2,ANS3)
                CALL CCX_CCX_NOH(P,H1,H2,ANS4)
                CALL CCX_DSX_NOH(P,H1,H2,ANS5)
                CALL CCX_SDX_NOH(P,H1,H2,ANS6)
                ANS=ANS1+ANS2+ANS3+ANS4+ANS5+ANS6
                CALL CCX_DDX_NOH(PP,H1,H2,ANS1)
                CALL CCX_UUX_NOH(PP,H1,H2,ANS2)
                CALL CCX_SSX_NOH(PP,H1,H2,ANS3)
                CALL CCX_CCX_NOH(PP,H1,H2,ANS4)
                CALL CCX_DSX_NOH(PP,H1,H2,ANS5)
                CALL CCX_SDX_NOH(PP,H1,H2,ANS6)
                ANS=ANS1+ANS2+ANS3+ANS4+ANS5+ANS6+ANS
                CALL CCX_GG_NOH(P,H1,H2,ANS1)
                ANS=ANS1+ANS
            ENDIF   
      ELSE
           WRITE(*,*) 'NOT FINISHED'
...
C ----- begin subprocesses  CCX->DDX  with Higgs->tautau

      SUBROUTINE CCX_DDX_H(P,H1,H2,ANS)
...
C     
C     Process: c c~ > d d~ h WEIGHTED=6
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CCX_DDX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CCX_DDX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      CALL FFV2_5_3(W(1,1),W(1,2),GC_51,GC_58,MZ,WZ,W(1,6))
...
C     Amplitude(s) for diagram number 2
      CALL VVS1_0(W(1,5),W(1,3),W(1,7),GC_72,AMP(2))
      JAMP(1)=-AMP(1)
      JAMP(2)=+AMP(2)
...
C ----- begin subprocesses  CCX->CCX  with Higgs->tautau

      SUBROUTINE CCX_CCX_H(P,H1,H2,ANS)
C     
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CCX_CCX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CCX_CCX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C ----- begin subprocesses  CCX->SSX  with Higgs->tautau

      SUBROUTINE CCX_SSX_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: c c~ > s s~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CCX_SSX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CCX_SSX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C ----- begin subprocesses  CCX->UUX  with Higgs->tautau

      SUBROUTINE CCX_UUX_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: c c~ > u u~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CCX_UUX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CCX_UUX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      CALL FFS4_3(W(1,5),W(1,6),GC_99,MH,WH,W(1,7))
      CALL FFV2_5_3(W(1,1),W(1,2),GC_51,GC_58,MZ,WZ,W(1,6))
      CALL FFV2_5_3(W(1,4),W(1,3),GC_51,GC_58,MZ,WZ,W(1,2))
C     Amplitude(s) for diagram number 1
...
C ----- begin subprocesses  CCX->DSX  with Higgs->tautau

      SUBROUTINE CCX_DSX_H(P,H1,H2,ANS)
C     
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: c c~ > d s~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CCX_DSX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CCX_DSX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C ------- BEFFINING SUBPROCESS CCX->SDX with H->tautau 

      SUBROUTINE CCX_SDX_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: c c~ > s d~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CCX_SDX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CCX_SDX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C-----------SUBPROCESS CCX->DDX NO HIGGS

      SUBROUTINE CCX_DDX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: c c~ > d d~ ta+ ta- / h Qed=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CCX_DDX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END

      REAL*8 FUNCTION MATRIX_CCX_DDX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV2_5_3(W(1,1),W(1,2),GC_51,GC_58,MZ,WZ,W(1,10))
...
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,4),W(1,10),W(1,12),GC_1,AMP(24))
      CALL FFV2_2(W(1,4),W(1,9),GC_44,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,6),W(1,2),W(1,12),GC_2,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFV2_3_0(W(1,4),W(1,10),W(1,7),GC_50,GC_58,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL FFV2_5_0(W(1,6),W(1,2),W(1,7),GC_51,GC_58,AMP(27))
      CALL FFV2_2(W(1,1),W(1,14),GC_44,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,6),W(1,3),W(1,12),GC_1,AMP(28))
...
C     Amplitude(s) for diagram number 43
     ...
     $ -1./2.*AMP(38)-1./2.*AMP(39)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
	  MATRIX_CCX_DDX_NOH=MATRIX
 	  ENDIF
      ENDIF
      END

C-----------SUBPROCESS CCX->UUX NO HIGGS

      SUBROUTINE CCX_UUX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: c c~ > u u~ ta+ ta- / h Qed=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CCX_UUX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CCX_UUX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,6),W(1,3),W(1,12),GC_2,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV2_5_0(W(1,4),W(1,9),W(1,7),GC_51,GC_58,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV2_5_0(W(1,6),W(1,3),W(1,7),GC_51,GC_58,AMP(16))
      CALL FFV2_5_1(W(1,3),W(1,10),GC_51,GC_58,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 17
...
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,9),W(1,2),W(1,12),GC_2,AMP(21))
      CALL FFV1_2(W(1,1),W(1,12),GC_2,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,6),W(1,2),W(1,8),GC_2,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV2_5_0(W(1,9),W(1,2),W(1,7),GC_51,GC_58,AMP(23))
      CALL FFV2_5_2(W(1,1),W(1,7),GC_51,GC_58,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,9),W(1,2),W(1,8),GC_2,AMP(24))
      CALL FFV1P0_3(W(1,4),W(1,3),GC_11,ZERO,ZERO,W(1,8))
      CALL FFV1_2(W(1,1),W(1,8),GC_11,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,4),W(1,2),W(1,12),GC_2,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFV1_0(W(1,6),W(1,2),W(1,8),GC_11,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL FFV2_5_0(W(1,4),W(1,2),W(1,7),GC_51,GC_58,AMP(27))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,9),W(1,2),W(1,8),GC_11,AMP(28))
      CALL FFV2_5_2(W(1,1),W(1,11),GC_51,GC_58,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,8),W(1,2),W(1,12),GC_2,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV2_5_0(W(1,6),W(1,2),W(1,11),GC_51,GC_58,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV2_5_0(W(1,8),W(1,2),W(1,7),GC_51,GC_58,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV2_5_0(W(1,9),W(1,2),W(1,11),GC_51,GC_58,AMP(32))
      JAMP(1)=-AMP(1)-AMP(2)-AMP(3)-AMP(4)-AMP(5)-AMP(6)-AMP(7)-AMP(8)
     $ -AMP(9)-AMP(10)-AMP(11)-AMP(12)+1./6.*AMP(13)+1./6.*AMP(14)
     $ +1./6.*AMP(15)+1./6.*AMP(16)-AMP(17)-AMP(18)-AMP(19)-AMP(20)
     ...
     $ -AMP(27)-AMP(28))
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_CCX_UUX_NOH=MATRIX
      ENDIF
      ENDIF 
      END

C-----------SUBPROCESS CCX->SSX NO HIGGS

      SUBROUTINE CCX_SSX_NOH(P,H1,H2,ANS)
C     
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: c c~ > s s~ ta+ ta- / h Qed=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CCX_SSX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CCX_SSX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,4),W(1,10),W(1,12),GC_1,AMP(24))
      CALL FFV2_2(W(1,4),W(1,9),GC_100,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,6),W(1,2),W(1,12),GC_2,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFV2_3_0(W(1,4),W(1,10),W(1,7),GC_50,GC_58,AMP(26))
...
C     Amplitude(s) for diagram number 30
      ...
      CALL FFV2_5_2(W(1,1),W(1,7),GC_51,GC_58,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 31
      CALL FFV2_0(W(1,6),W(1,3),W(1,14),GC_100,AMP(31))
      CALL FFV1_2(W(1,1),W(1,8),GC_2,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,14),W(1,2),W(1,12),GC_2,AMP(32))
C     Amplitude(s) for diagram number 33
...
C     Amplitude(s) for diagram number 43
     ...
     $ -1./2.*AMP(38)-1./2.*AMP(39)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_CCX_SSX_NOH=MATRIX
      ENDIF
      ENDIF
      END

C-----------SUBPROCESS CCX->CCX NO HIGGS

      SUBROUTINE CCX_CCX_NOH(P,H1,H2,ANS)
C     
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CCX_CCX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CCX_CCX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 20
      CALL FFV2_5_0(W(1,9),W(1,3),W(1,7),GC_51,GC_58,AMP(20))
      CALL FFV1P0_3(W(1,1),W(1,3),GC_2,ZERO,ZERO,W(1,9))
      CALL FFV1P0_3(W(1,4),W(1,2),GC_2,ZERO,ZERO,W(1,14))
...
C     Amplitude(s) for diagram number 22
      ...
      CALL FFV2_5_3(W(1,4),W(1,2),GC_51,GC_58,MZ,WZ,W(1,15))
C     Amplitude(s) for diagram number 23
...
C     Amplitude(s) for diagram number 28
      ...
      CALL FFV1_1(W(1,2),W(1,9),GC_2,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,4),W(1,16),W(1,12),GC_2,AMP(29))
      CALL FFV1_2(W(1,4),W(1,9),GC_2,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 30
      CALL FFV1_0(W(1,5),W(1,2),W(1,12),GC_2,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV2_5_0(W(1,4),W(1,16),W(1,7),GC_51,GC_58,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV2_5_0(W(1,5),W(1,2),W(1,7),GC_51,GC_58,AMP(32))
      CALL FFV1P0_3(W(1,1),W(1,3),GC_11,ZERO,ZERO,W(1,5))
      CALL FFV1_1(W(1,2),W(1,5),GC_11,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,4),W(1,16),W(1,12),GC_2,AMP(33))
      CALL FFV1_2(W(1,4),W(1,5),GC_11,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 34
      CALL FFV1_0(W(1,9),W(1,2),W(1,12),GC_2,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL FFV2_5_0(W(1,4),W(1,16),W(1,7),GC_51,GC_58,AMP(35))
C     Amplitude(s) for diagram number 36
      CALL FFV2_5_0(W(1,9),W(1,2),W(1,7),GC_51,GC_58,AMP(36))
      CALL FFV2_5_1(W(1,2),W(1,13),GC_51,GC_58,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 37
      CALL FFV1_0(W(1,4),W(1,9),W(1,12),GC_2,AMP(37))
      CALL FFV2_5_2(W(1,4),W(1,13),GC_51,GC_58,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 38
      CALL FFV1_0(W(1,16),W(1,2),W(1,12),GC_2,AMP(38))
C     Amplitude(s) for diagram number 39
      CALL FFV2_5_0(W(1,4),W(1,9),W(1,7),GC_51,GC_58,AMP(39))
C     Amplitude(s) for diagram number 40
      CALL FFV2_5_0(W(1,16),W(1,2),W(1,7),GC_51,GC_58,AMP(40))
      CALL FFV1_2(W(1,1),W(1,14),GC_2,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 41
      CALL FFV1_0(W(1,16),W(1,3),W(1,12),GC_2,AMP(41))
      CALL FFV1_2(W(1,1),W(1,12),GC_2,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 42
      CALL FFV1_0(W(1,9),W(1,3),W(1,14),GC_2,AMP(42))
C     Amplitude(s) for diagram number 43
      CALL FFV2_5_0(W(1,16),W(1,3),W(1,7),GC_51,GC_58,AMP(43))
      CALL FFV2_5_2(W(1,1),W(1,7),GC_51,GC_58,ZERO,ZERO,W(1,16))
C     Amplitude(s) for diagram number 44
      CALL FFV1_0(W(1,16),W(1,3),W(1,14),GC_2,AMP(44))
...
C     Amplitude(s) for diagram number 49
      CALL FFV1_0(W(1,14),W(1,3),W(1,12),GC_2,AMP(49))
C     Amplitude(s) for diagram number 50
      CALL FFV2_5_0(W(1,9),W(1,3),W(1,15),GC_51,GC_58,AMP(50))
C     Amplitude(s) for diagram number 51
      CALL FFV2_5_0(W(1,14),W(1,3),W(1,7),GC_51,GC_58,AMP(51))
C     Amplitude(s) for diagram number 52
      CALL FFV2_5_0(W(1,16),W(1,3),W(1,15),GC_51,GC_58,AMP(52))
      CALL FFV1_2(W(1,1),W(1,8),GC_2,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 53
      CALL FFV1_0(W(1,15),W(1,2),W(1,12),GC_2,AMP(53))
C     Amplitude(s) for diagram number 54
      CALL FFV1_0(W(1,9),W(1,2),W(1,8),GC_2,AMP(54))
C     Amplitude(s) for diagram number 55
      CALL FFV2_5_0(W(1,15),W(1,2),W(1,7),GC_51,GC_58,AMP(55))
C     Amplitude(s) for diagram number 56
      CALL FFV1_0(W(1,16),W(1,2),W(1,8),GC_2,AMP(56))
      CALL FFV1P0_3(W(1,4),W(1,3),GC_11,ZERO,ZERO,W(1,8))
      CALL FFV1_2(W(1,1),W(1,8),GC_11,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 57
      CALL FFV1_0(W(1,4),W(1,2),W(1,12),GC_2,AMP(57))
C     Amplitude(s) for diagram number 58
      CALL FFV1_0(W(1,9),W(1,2),W(1,8),GC_11,AMP(58))
C     Amplitude(s) for diagram number 59
      CALL FFV2_5_0(W(1,4),W(1,2),W(1,7),GC_51,GC_58,AMP(59))
C     Amplitude(s) for diagram number 60
      CALL FFV1_0(W(1,16),W(1,2),W(1,8),GC_11,AMP(60))
      CALL FFV2_5_2(W(1,1),W(1,11),GC_51,GC_58,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 61
      CALL FFV1_0(W(1,8),W(1,2),W(1,12),GC_2,AMP(61))
C     Amplitude(s) for diagram number 62
      CALL FFV2_5_0(W(1,9),W(1,2),W(1,11),GC_51,GC_58,AMP(62))
C     Amplitude(s) for diagram number 63
      CALL FFV2_5_0(W(1,8),W(1,2),W(1,7),GC_51,GC_58,AMP(63))
C     Amplitude(s) for diagram number 64
      CALL FFV2_5_0(W(1,16),W(1,2),W(1,11),GC_51,GC_58,AMP(64))
      JAMP(1)=-AMP(1)-AMP(2)-AMP(3)-AMP(4)-AMP(5)-AMP(6)-AMP(7)-AMP(8)
     $ -AMP(9)-AMP(10)-AMP(11)-AMP(12)+1./6.*AMP(13)+1./6.*AMP(14)
     $ +1./6.*AMP(15)+1./6.*AMP(16)-AMP(17)-AMP(18)-AMP(19)-AMP(20)
     ...
     $ -1./2.*AMP(60)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_CCX_CCX_NOH=MATRIX
      ENDIF
      ENDIF
      END

C -----------------SUBPROCESS CCX->DSX, NO HIGGS

      SUBROUTINE CCX_DSX_NOH(P,H1,H2,ANS)
C     
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: c c~ > d s~ ta+ ta- / h Qed=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CCX_DSX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CCX_DSX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 11
     ...
     $ +AMP(9)+AMP(10)+AMP(11)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_CCX_DSX_NOH=MATRIX
      ENDIF
      ENDIF
      END

C ----------------SUBPROCESS CCX->SDX, NO HIGGS

      SUBROUTINE CCX_SDX_NOH(P,H1,H2,ANS)
C     
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: c c~ > s d~ ta+ ta- / h Qed=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CCX_SDX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CCX_SDX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C  --- BEGIN SUBROUTINE CCX->GG NO HIGGS


      SUBROUTINE CCX_GG_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: c c~ > g g ta+ ta- / h Qed=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CCX_GG_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CCX_GG_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      CALL FFV1_1(W(1,2),W(1,4),GC_11,ZERO,ZERO,W(1,8))
      CALL FFV1P0_3(W(1,5),W(1,6),GC_3,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,7),W(1,8),W(1,9),GC_2,AMP(1))
      CALL FFV2_4_3(W(1,5),W(1,6),GC_50,GC_59,MZ,WZ,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL FFV2_5_0(W(1,7),W(1,8),W(1,10),GC_51,GC_58,AMP(2))
      CALL FFV1_2(W(1,7),W(1,4),GC_11,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 3
      CALL FFV1_0(W(1,6),W(1,2),W(1,9),GC_2,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV2_5_0(W(1,6),W(1,2),W(1,10),GC_51,GC_58,AMP(4))
      CALL FFV1_2(W(1,1),W(1,4),GC_11,ZERO,ZERO,W(1,6))
      CALL FFV1_1(W(1,2),W(1,3),GC_11,ZERO,ZERO,W(1,7))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,6),W(1,7),W(1,9),GC_2,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_5_0(W(1,6),W(1,7),W(1,10),GC_51,GC_58,AMP(6))
      CALL FFV1_2(W(1,6),W(1,3),GC_11,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,5),W(1,2),W(1,9),GC_2,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_5_0(W(1,5),W(1,2),W(1,10),GC_51,GC_58,AMP(8))
      CALL FFV1_2(W(1,1),W(1,9),GC_2,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,5),W(1,7),W(1,4),GC_11,AMP(9))
      CALL FFV2_5_2(W(1,1),W(1,10),GC_51,GC_58,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,6),W(1,7),W(1,4),GC_11,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,5),W(1,8),W(1,3),GC_11,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV1_0(W(1,6),W(1,8),W(1,3),GC_11,AMP(12))
      CALL VVV1P0_1(W(1,3),W(1,4),GC_10,ZERO,ZERO,W(1,8))
      CALL FFV1_2(W(1,1),W(1,8),GC_11,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,4),W(1,2),W(1,9),GC_2,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,5),W(1,2),W(1,8),GC_11,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV2_5_0(W(1,4),W(1,2),W(1,10),GC_51,GC_58,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,6),W(1,2),W(1,8),GC_11,AMP(16))
      JAMP(1)=+AMP(5)+AMP(6)+AMP(7)+AMP(8)+AMP(9)+AMP(10)-IMAG1
     $ *AMP(13)-IMAG1*AMP(14)-IMAG1*AMP(15)-IMAG1*AMP(16)
      JAMP(2)=+AMP(1)+AMP(2)+AMP(3)+AMP(4)+AMP(11)+AMP(12)+IMAG1
     $ *AMP(13)+IMAG1*AMP(14)+IMAG1*AMP(15)+IMAG1*AMP(16)
