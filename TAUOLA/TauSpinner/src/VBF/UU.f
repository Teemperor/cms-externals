C  JK. corrected 20.11.2014
c------------------begin subprocess initiated by UU----------
...
C      I3=0,2             I4=0,2    ! only uu->uu

      ANS=0.D0

      IF(KEY.EQ.1) THEN
         IF(I3.EQ.2 .AND. I4.EQ.2) CALL UU_UU_H(P,H1,H2,ANS)
         IF(I3.EQ.0 .AND. I4.EQ.0) CALL UU_UU_H(P,H1,H2,ANS)
      ELSE IF(KEY.EQ.0) THEN
         IF(I3.EQ.2 .AND. I4.EQ.2) CALL UU_UU_NOH(P,H1,H2,ANS)
         IF(I3.EQ.0 .AND. I4.EQ.0) CALL UU_UU_NOH(P,H1,H2,ANS)
      ELSE
...
C ---------begin subprocess UU->jjH with H-> tautau
c   ---------------------jj=uu only -------------

      SUBROUTINE UU_UU_H(P,H1,H2,ANS)
C
C
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_UU_UU_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_UU_UU_H(P,H1,H2,NHEL,IC)
C
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 2
      ...
      ENDDO
      MATRIX_UU_UU_H=MATRIX
      ENDIF
      ENDIF
      END
C----------------end subprocess uu->jjH---------

c----------------begin subprocess uu->jj_noH



      SUBROUTINE UU_UU_NOH(P,H1,H2,ANS)
C
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_UU_UU_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_UU_UU_NOH(P,H1,H2,NHEL,IC)
C
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
