...
c ---------------------   subprocesses initiated by CS:      13.08.2015
 
      SUBROUTINE  CS(P,I3,I4,H1,H2,KEY,ANS)
      IMPLICIT NONE
...
C      I3=0,2 OR 4             I4=0,1 OR 3
      ...
      IF(KEY.EQ.1) THEN
         IF(I3.EQ.2 .AND. I4.EQ.1) CALL CS_UD_H(P,H1,H2,ANS)
         IF(I3.EQ.2 .AND. I4.EQ.3) CALL CS_US_H(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.1) CAll CS_CD_H(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.3) CALL CS_CS_H(P,H1,H2,ANS)
            IF(I3.EQ.0 .AND. I4.EQ.0) THEN 
                CALL CS_UD_H(P,H1,H2,ANS1)
                CALL CS_US_H(P,H1,H2,ANS2)
                CALL CS_CD_H(P,H1,H2,ANS3)
                CALL CS_CS_H(P,H1,H2,ANS4)
                ANS=ANS1+ANS2+ANS3+ANS4
            ENDIF
      ELSE IF(KEY.EQ.0) THEN 
         IF(I3.EQ.2 .AND. I4.EQ.1) CALL CS_UD_NOH(P,H1,H2,ANS)
         IF(I3.EQ.2 .AND. I4.EQ.3) CALL CS_US_NOH(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.1) CAll CS_CD_NOH(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.3) CALL CS_CS_NOH(P,H1,H2,ANS)
            IF(I3.EQ.0 .AND. I4.EQ.0) THEN 
                CALL CS_UD_NOH(P,H1,H2,ANS1)
                CALL CS_US_NOH(P,H1,H2,ANS2)
                CALL CS_CD_NOH(P,H1,H2,ANS3)
                CALL CS_CS_NOH(P,H1,H2,ANS4)
                ANS=ANS1+ANS2+ANS3+ANS4
            ENDIF   
      ELSE
           WRITE(*,*) 'NOT FINISHED'
...
C ----- begin subprocesses  CS->jjH  with Higgs->tautau

      SUBROUTINE CS_CD_H(P,H1,H2,ANS)
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CS_CD_H(P,H1,H2 ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CS_CD_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
c==========================================
      ...
      SUBROUTINE CS_CS_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CS_CS_H(P,H1,H2 ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CS_CS_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C===============================================
      ...
      SUBROUTINE CS_UD_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CS_UD_H(P,H1,H2 ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CS_UD_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C======================================== 
      ...
      SUBROUTINE CS_US_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CS_US_H(P,H1,H2 ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CS_US_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C  ---  end of subprocess CS->jjH, H->tautau

C ----- begin subprocesses CS->jjtautau, no Higgs

      SUBROUTINE CS_CD_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CS_CD_NOH(P,H1,H2 ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CS_CD_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 11
     ...
     $ +AMP(9)+AMP(10)+AMP(11)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_CS_CD_NOH=MATRIX
      ENDIF                ! CLOSES H1 IF 
      ENDIF                ! CLOSES H2 IF
      END


      SUBROUTINE CS_CS_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CS_CS_NOH(P,H1,H2 ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CS_CS_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 43
     ...
     $ -1./2.*AMP(38)-1./2.*AMP(39)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_CS_CS_NOH=MATRIX
      ENDIF                ! CLOSES H1 IF 
      ENDIF                ! CLOSES H2 IF
      END

      SUBROUTINE CS_UD_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CS_UD_NOH(P,H1,H2 ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CS_UD_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 11
     ...
     $ +AMP(9)+AMP(10)+AMP(11)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_CS_UD_NOH=MATRIX
      ENDIF                ! CLOSES H1 IF 
      ENDIF                ! CLOSES H2 IF
      END


      SUBROUTINE CS_US_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CS_US_NOH(P,H1,H2 ,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CS_US_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 11
     ...
     $ +AMP(9)+AMP(10)+AMP(11)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_CS_US_NOH=MATRIX
      ENDIF                ! CLOSES H1 IF 
      ENDIF                ! CLOSES H2 IF
      END


C  ------- end subprocesses CS->jjtautau, no Higgs
