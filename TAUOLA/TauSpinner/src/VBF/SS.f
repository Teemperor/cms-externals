C  JK. done 26.10.2015
c------------------begin subprocess initiated by SS----------
      SUBROUTINE  SS(P,I3,I4,H1,H2,KEY,ANS)
      IMPLICIT NONE
 
      INTEGER I3,I4,   H1,H2,   KEY
      REAL*8 P(0:3,6), ANS

C      I3=0,3             I4=0,3    ! only SS->SS
      
      ANS=0.D0

      IF(KEY.EQ.1) THEN
         IF(I3.EQ.3 .AND. I4.EQ.3) CALL SS_SS_H(P,H1,H2,ANS)
         IF(I3.EQ.0 .AND. I4.EQ.0) CALL SS_SS_H(P,H1,H2,ANS)
      ELSE IF(KEY.EQ.0) THEN 
         IF(I3.EQ.3 .AND. I4.EQ.3) CALL SS_SS_NOH(P,H1,H2,ANS)
         IF(I3.EQ.0 .AND. I4.EQ.0) CALL SS_SS_NOH(P,H1,H2,ANS)
      ELSE 
...
C ---------begin subprocess SS->jjH with H-> tautau
c   ---------------------jj=SS only -------------

      SUBROUTINE SS_SS_H(P,H1,H2,ANS)
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SS_SS_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SS_SS_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 2
      ...
      ENDDO
      MATRIX_SS_SS_H=MATRIX
      ENDIF             ! CLOSES H1 IF
      ENDIF             ! CLOSES H2 IF
      END
C-----------------------end subprocess SS->SSH-------------




c-----------------begin subprocess SS->jj_noH--------------
c                           jj=SS only

      SUBROUTINE SS_SS_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
        T=MATRIX_SS_SS_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
        ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SS_SS_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 64
     ...
     $ -1./2.*AMP(60)
      ...
      ZTEMP = (0.D0,0.D0)
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_SS_SS_NOH=MATRIX
      ENDIF
      ENDIF
      END
C---------------------end subprocess initiated by SS------- 
C DONE 26.10.2015
