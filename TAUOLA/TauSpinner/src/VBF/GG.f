...
c------------------begin subprocess initiated by GG----------

      SUBROUTINE  GG(P,I3,I4,H1,H2,KEY,ANS)
      IMPLICIT NONE
...
C      I3=1              I4=-1    ! gg->ddbar
C      I3=2              I4=-2    ! gg->uubar
c      I3=I4=0                    ! gg->ddbar+uubar
      ...
      ELSE IF(KEY.EQ.0) THEN 
         IF(I3.EQ.1 .AND. I4.EQ.-1) CALL GG_DDX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.-1 .AND. I4.EQ.1) CALL GG_DDX_NOH(PP,H1,H2,ANS)
         IF(I3.EQ.2 .AND. I4.EQ.-2) CALL GG_UUX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.-2 .AND. I4.EQ.2) CALL GG_UUX_NOH(PP,H1,H2,ANS)
          IF(I3.EQ.3 .AND. I4.EQ.-3) CALL GG_DDX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.-3 .AND. I4.EQ.3) CALL GG_DDX_NOH(PP,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.-4) CALL GG_UUX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.-4 .AND. I4.EQ.4) CALL GG_UUX_NOH(PP,H1,H2,ANS)
          IF(I3.EQ.5 .AND. I4.EQ.-5) CALL GG_DDX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.-5 .AND. I4.EQ.5) CALL GG_DDX_NOH(PP,H1,H2,ANS)
 
         IF(I3.EQ.0 .AND. I4.EQ.0) THEN
            CALL GG_DDX_NOH(P,H1,H2,ANS1)
            CALL GG_UUX_NOH(P,H1,H2,ANS2)
            ANS=ANS1+ANS2
            CALL GG_DDX_NOH(PP,H1,H2,ANS1)
            CALL GG_UUX_NOH(PP,H1,H2,ANS2)
            ANS=ANS1+ANS2+ANS
         ENDIF
      ELSE 
...
c ------- no subprocesses for gluon-gluon->jjH

c --------------- begin subprocesses initiated by gloun-gluon, no Higgs 

c------- subprocess gg->ddbar, no Higgs

      SUBROUTINE GG_DDX_NOH(P,H1,H2,ANS)
C     
...
C     
C     Process: g g > d d~ ta+ ta- / h QED=4
C     Process: g g > s s~ ta+ ta- / h QED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_GG_DDX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_GG_DDX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,4),W(1,9),W(1,8),GC_1,AMP(1))
      CALL FFV1_2(W(1,4),W(1,7),GC_11,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL FFV1_0(W(1,10),W(1,3),W(1,8),GC_1,AMP(2))
      CALL FFV2_4_3(W(1,5),W(1,6),GC_50,GC_59,MZ,WZ,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFV2_3_0(W(1,4),W(1,9),W(1,7),GC_50,GC_58,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV2_3_0(W(1,10),W(1,3),W(1,7),GC_50,GC_58,AMP(4))
      CALL FFV1_1(W(1,3),W(1,1),GC_11,ZERO,ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1_1(W(1,10),W(1,2),GC_11,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,4),W(1,6),W(1,8),GC_1,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_3_0(W(1,4),W(1,6),W(1,7),GC_50,GC_58,AMP(8))
      CALL FFV1_2(W(1,4),W(1,1),GC_11,ZERO,ZERO,W(1,6))
      CALL FFV1_1(W(1,3),W(1,2),GC_11,ZERO,ZERO,W(1,10))
...
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,5),W(1,3),W(1,8),GC_1,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV2_3_0(W(1,5),W(1,3),W(1,7),GC_50,GC_58,AMP(12))
      CALL FFV1_1(W(1,10),W(1,1),GC_11,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,4),W(1,5),W(1,8),GC_1,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV2_3_0(W(1,4),W(1,5),W(1,7),GC_50,GC_58,AMP(14))
      CALL FFV1_2(W(1,9),W(1,1),GC_11,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,5),W(1,3),W(1,8),GC_1,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV2_3_0(W(1,5),W(1,3),W(1,7),GC_50,GC_58,AMP(16))
     ...
     $ -AMP(9)-AMP(10)-AMP(11)-AMP(12)-AMP(13)-AMP(14)
      ...
      ENDDO
      MATRIX_GG_DDX_NOH=MATRIX
      ENDIF
      ENDIF
      END


c--------subprocess gg->uubar, no Higgs

      SUBROUTINE GG_UUX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: g g > u u~ ta+ ta- / h QED=4
C     Process: g g > c c~ ta+ ta- / h QED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_GG_UUX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_GG_UUX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_4_3(W(1,5),W(1,6),GC_50,GC_59,MZ,WZ,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFV2_5_0(W(1,4),W(1,9),W(1,7),GC_51,GC_58,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV2_5_0(W(1,10),W(1,3),W(1,7),GC_51,GC_58,AMP(4))
      CALL FFV1_1(W(1,3),W(1,1),GC_11,ZERO,ZERO,W(1,10))
      CALL FFV1_2(W(1,4),W(1,2),GC_11,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 5
...
C     Amplitude(s) for diagram number 6
      ...
      CALL FFV1_1(W(1,10),W(1,2),GC_11,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,4),W(1,6),W(1,8),GC_2,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_5_0(W(1,4),W(1,6),W(1,7),GC_51,GC_58,AMP(8))
      CALL FFV1_2(W(1,4),W(1,1),GC_11,ZERO,ZERO,W(1,6))
      CALL FFV1_1(W(1,3),W(1,2),GC_11,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 9
...
C     Amplitude(s) for diagram number 10
      ...
      CALL FFV1_2(W(1,6),W(1,2),GC_11,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,5),W(1,3),W(1,8),GC_2,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV2_5_0(W(1,5),W(1,3),W(1,7),GC_51,GC_58,AMP(12))
      CALL FFV1_1(W(1,10),W(1,1),GC_11,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,4),W(1,5),W(1,8),GC_2,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV2_5_0(W(1,4),W(1,5),W(1,7),GC_51,GC_58,AMP(14))
      CALL FFV1_2(W(1,9),W(1,1),GC_11,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,5),W(1,3),W(1,8),GC_2,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV2_5_0(W(1,5),W(1,3),W(1,7),GC_51,GC_58,AMP(16))
      JAMP(1)=+IMAG1*AMP(1)+IMAG1*AMP(2)+IMAG1*AMP(3)+IMAG1*AMP(4)
     $ -AMP(5)-AMP(6)-AMP(7)-AMP(8)-AMP(15)-AMP(16)
      JAMP(2)=-IMAG1*AMP(1)-IMAG1*AMP(2)-IMAG1*AMP(3)-IMAG1*AMP(4)
     $ -AMP(9)-AMP(10)-AMP(11)-AMP(12)-AMP(13)-AMP(14)
