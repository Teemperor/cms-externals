...
c ---------------------   subprocesses initiated by SU:      27.10.2015
 
      SUBROUTINE  SU(P,I3,I4,H1,H2,KEY,ANS)
      IMPLICIT NONE
...
C      I3=0,2 OR 4             I4=0,1 OR 3
      ...
      IF(KEY.EQ.1) THEN
         IF(I3.EQ.2 .AND. I4.EQ.1) CALL SU_UD_H(P,H1,H2,ANS)
         IF(I3.EQ.2 .AND. I4.EQ.3) CALL SU_US_H(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.1) CAll SU_CD_H(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.3) CALL SU_CS_H(P,H1,H2,ANS)
            IF(I3.EQ.0 .AND. I4.EQ.0) THEN 
                CALL SU_UD_H(P,H1,H2,ANS1)
                CALL SU_US_H(P,H1,H2,ANS2)
                CALL SU_CD_H(P,H1,H2,ANS3)
                CALL SU_CS_H(P,H1,H2,ANS4)
                ANS=ANS1+ANS2+ANS3+ANS4
            ENDIF
      ELSE IF(KEY.EQ.0) THEN 
         IF(I3.EQ.2 .AND. I4.EQ.1) CALL SU_UD_NOH(P,H1,H2,ANS)
         IF(I3.EQ.2 .AND. I4.EQ.3) CALL SU_US_NOH(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.1) CAll SU_CD_NOH(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.3) CALL SU_CS_NOH(P,H1,H2,ANS)
            IF(I3.EQ.0 .AND. I4.EQ.0) THEN 
                CALL SU_UD_NOH(P,H1,H2,ANS1)
                CALL SU_US_NOH(P,H1,H2,ANS2)
                CALL SU_CD_NOH(P,H1,H2,ANS3)
                CALL SU_CS_NOH(P,H1,H2,ANS4)
                ANS=ANS1+ANS2+ANS3+ANS4
            ENDIF   
      ELSE 
		   WRITE(*,*) 'NOT FINISHED'
...
C ----- begin subprocesses  US->jjH  with Higgs->tautau

      SUBROUTINE SU_CD_H(P,H1,H2,ANS)
C     
...
C     
C     Process: s u > c d h WEIGHTED=6
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SU_CD_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SU_CD_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      CALL FFV2_3(W(1,2),W(1,4),GC_100,MW,WW,W(1,3))
...
c==========================================
      ...
      SUBROUTINE SU_CS_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s u > c s h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SU_CS_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SU_CS_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      CALL FFS4_3(W(1,5),W(1,6),GC_99,MH,WH,W(1,7))
      CALL FFV2_3(W(1,1),W(1,3),GC_100,MW,WW,W(1,6))
      CALL FFV2_3(W(1,2),W(1,4),GC_101,MW,WW,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL VVS1_0(W(1,3),W(1,6),W(1,7),GC_72,AMP(1))
      JAMP(1)=-AMP(1)
...
C===============================================
      ...
      SUBROUTINE SU_UD_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s u > u d h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SU_UD_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SU_UD_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C======================================== 
      ...
      SUBROUTINE SU_US_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s u > u s h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SU_US_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SU_US_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      CALL FFS4_3(W(1,5),W(1,6),GC_99,MH,WH,W(1,7))
      CALL FFV2_3(W(1,1),W(1,3),GC_101,MW,WW,W(1,6))
      CALL FFV2_3(W(1,2),W(1,4),GC_101,MW,WW,W(1,5))
C     Amplitude(s) for diagram number 1
...
C  ---  end of subprocess SU->jjH, H->tautau

C ----- begin subprocesses SU->jjtautau, no Higgs

      SUBROUTINE SU_CD_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s u > c d ta+ ta- / h QED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SU_CD_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SU_CD_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      CALL FFV2_3(W(1,2),W(1,4),GC_100,MW,WW,W(1,8))
...
C     Amplitude(s) for diagram number 4
      ...
      CALL FFV2_1(W(1,4),W(1,7),GC_100,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,2),W(1,5),W(1,9),GC_2,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_3_0(W(1,6),W(1,4),W(1,10),GC_50,GC_58,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV2_5_0(W(1,2),W(1,5),W(1,10),GC_51,GC_58,AMP(7))
...
C     Amplitude(s) for diagram number 11
     ...
     $ -AMP(9)-AMP(10)-AMP(11)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_SU_CD_NOH=MATRIX
      ENDIF                ! CLOSES H1 IF 
      ENDIF                ! CLOSES H2 IF
      END


      SUBROUTINE SU_CS_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s u > c s ta+ ta- / h QED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SU_CS_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SU_CS_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      CALL OXXXXX(P(0,6),MTA,NHEL(6),+1*IC(6),W(1,6))
      CALL FFV2_3(W(1,1),W(1,3),GC_100,MW,WW,W(1,7))
      CALL FFV2_3(W(1,2),W(1,4),GC_101,MW,WW,W(1,8))
      CALL FFV2_1(W(1,6),W(1,7),GC_108,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV2_0(W(1,5),W(1,9),W(1,8),GC_108,AMP(1))
      CALL FFV1P0_3(W(1,5),W(1,6),GC_3,ZERO,ZERO,W(1,9))
...
C     Amplitude(s) for diagram number 3
      CALL VVV1_0(W(1,8),W(1,7),W(1,10),GC_53,AMP(3))
      CALL FFV2_2(W(1,2),W(1,7),GC_101,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,6),W(1,4),W(1,9),GC_1,AMP(4))
      CALL FFV2_1(W(1,4),W(1,7),GC_101,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,2),W(1,5),W(1,9),GC_2,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_3_0(W(1,6),W(1,4),W(1,10),GC_50,GC_58,AMP(6))
...
C     Amplitude(s) for diagram number 11
     ...
     $ -AMP(9)-AMP(10)-AMP(11)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_SU_CS_NOH=MATRIX
      ENDIF                ! CLOSES H1 IF 
      ENDIF                ! CLOSES H2 IF
      END

      SUBROUTINE SU_UD_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s u > u d ta+ ta- / h QED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SU_UD_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SU_UD_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 11
     ...
     $ -AMP(9)-AMP(10)-AMP(11)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_SU_UD_NOH=MATRIX
      ENDIF                ! CLOSES H1 IF 
      ENDIF                ! CLOSES H2 IF
      END


      SUBROUTINE SU_US_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s u > u s ta+ ta- / h QED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SU_US_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SU_US_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 3
      CALL VVV1_0(W(1,8),W(1,7),W(1,10),GC_53,AMP(3))
      CALL FFV2_2(W(1,2),W(1,7),GC_101,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,11),W(1,4),W(1,9),GC_1,AMP(4))
      CALL FFV2_1(W(1,4),W(1,7),GC_101,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,2),W(1,12),W(1,9),GC_2,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_3_0(W(1,11),W(1,4),W(1,10),GC_50,GC_58,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV2_5_0(W(1,2),W(1,12),W(1,10),GC_51,GC_58,AMP(7))
      CALL FFV1P0_3(W(1,1),W(1,4),GC_1,ZERO,ZERO,W(1,12))
      CALL FFV1P0_3(W(1,2),W(1,3),GC_2,ZERO,ZERO,W(1,11))
...
C     Amplitude(s) for diagram number 9
      ...
      CALL FFV2_5_3(W(1,2),W(1,3),GC_51,GC_58,MZ,WZ,W(1,14))
C     Amplitude(s) for diagram number 10
...
C     Amplitude(s) for diagram number 15
      ...
      CALL FFV1_2(W(1,2),W(1,12),GC_2,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 16
      CALL FFV1_0(W(1,15),W(1,3),W(1,9),GC_2,AMP(16))
      CALL FFV1_1(W(1,3),W(1,12),GC_2,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,2),W(1,5),W(1,9),GC_2,AMP(17))
C     Amplitude(s) for diagram number 18
      CALL FFV2_5_0(W(1,15),W(1,3),W(1,10),GC_51,GC_58,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV2_5_0(W(1,2),W(1,5),W(1,10),GC_51,GC_58,AMP(19))
      CALL FFV1P0_3(W(1,1),W(1,4),GC_11,ZERO,ZERO,W(1,5))
      CALL FFV1_2(W(1,2),W(1,5),GC_11,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 20
      CALL FFV1_0(W(1,15),W(1,3),W(1,9),GC_2,AMP(20))
      CALL FFV1_1(W(1,3),W(1,5),GC_11,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,2),W(1,12),W(1,9),GC_2,AMP(21))
C     Amplitude(s) for diagram number 22
      CALL FFV2_5_0(W(1,15),W(1,3),W(1,10),GC_51,GC_58,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV2_5_0(W(1,2),W(1,12),W(1,10),GC_51,GC_58,AMP(23))
      CALL FFV2_5_2(W(1,2),W(1,13),GC_51,GC_58,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,12),W(1,3),W(1,9),GC_2,AMP(24))
      CALL FFV2_5_1(W(1,3),W(1,13),GC_51,GC_58,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,2),W(1,15),W(1,9),GC_2,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFV2_5_0(W(1,12),W(1,3),W(1,10),GC_51,GC_58,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL FFV2_5_0(W(1,2),W(1,15),W(1,10),GC_51,GC_58,AMP(27))
      CALL FFV1_2(W(1,1),W(1,11),GC_1,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,15),W(1,4),W(1,9),GC_1,AMP(28))
      CALL FFV1_2(W(1,1),W(1,9),GC_1,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,12),W(1,4),W(1,11),GC_1,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV2_3_0(W(1,15),W(1,4),W(1,10),GC_50,GC_58,AMP(30))
      CALL FFV2_3_2(W(1,1),W(1,10),GC_50,GC_58,ZERO,ZERO,W(1,15))
C     Amplitude(s) for diagram number 31
      CALL FFV1_0(W(1,15),W(1,4),W(1,11),GC_1,AMP(31))
      CALL FFV1P0_3(W(1,2),W(1,3),GC_11,ZERO,ZERO,W(1,11))
      CALL FFV1_2(W(1,1),W(1,11),GC_11,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,2),W(1,4),W(1,9),GC_1,AMP(32))
C     Amplitude(s) for diagram number 33
      CALL FFV1_0(W(1,12),W(1,4),W(1,11),GC_11,AMP(33))
C     Amplitude(s) for diagram number 34
      CALL FFV2_3_0(W(1,2),W(1,4),W(1,10),GC_50,GC_58,AMP(34))
C     Amplitude(s) for diagram number 35
      CALL FFV1_0(W(1,15),W(1,4),W(1,11),GC_11,AMP(35))
      CALL FFV2_3_2(W(1,1),W(1,14),GC_50,GC_58,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 36
      CALL FFV1_0(W(1,11),W(1,4),W(1,9),GC_1,AMP(36))
C     Amplitude(s) for diagram number 37
      CALL FFV2_3_0(W(1,12),W(1,4),W(1,14),GC_50,GC_58,AMP(37))
C     Amplitude(s) for diagram number 38
      CALL FFV2_3_0(W(1,11),W(1,4),W(1,10),GC_50,GC_58,AMP(38))
C     Amplitude(s) for diagram number 39
      CALL FFV2_3_0(W(1,15),W(1,4),W(1,14),GC_50,GC_58,AMP(39))
      CALL FFV2_2(W(1,1),W(1,8),GC_101,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 40
      CALL FFV1_0(W(1,14),W(1,3),W(1,9),GC_2,AMP(40))
C     Amplitude(s) for diagram number 41
      CALL FFV2_0(W(1,12),W(1,3),W(1,8),GC_101,AMP(41))
C     Amplitude(s) for diagram number 42
      CALL FFV2_5_0(W(1,14),W(1,3),W(1,10),GC_51,GC_58,AMP(42))
C     Amplitude(s) for diagram number 43
      CALL FFV2_0(W(1,15),W(1,3),W(1,8),GC_101,AMP(43))
     ...
     $ +AMP(38)+AMP(39)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_SU_US_NOH=MATRIX
      ENDIF                ! CLOSES H1 IF 
      ENDIF                ! CLOSES H2 IF
      END


C  ------- end subprocesses SU->jjtautau, no Higgs
C DONE 27.10.2015
