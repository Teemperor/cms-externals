...
c ---------------------   subprocesses initiated by s dbar:  SDX      21.10.2015
 
      SUBROUTINE  SDX(P,I3,I4,H1,H2,KEY,ANS)
      IMPLICIT NONE
...
C      I3=0,2,3 OR 4             I4=0,-2,-3 OR -4
      ...
      IF(KEY.EQ.1) THEN
         IF(I3.EQ.2 .AND. I4.EQ.-2) CALL SDX_UUX_H(P,H1,H2,ANS)
         IF(I3.EQ.2 .AND. I4.EQ.-4) CALL SDX_UCX_H(P,H1,H2,ANS)
         IF(I3.EQ.3 .AND. I4.EQ.-1) CAll SDX_SDX_H(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.-2) CALL SDX_CUX_H(P,H1,H2,ANS)
		 IF(I3.EQ.4 .AND. I4.EQ.-4) CALL SDX_CCX_H(P,H1,H2,ANS)
            IF(I3.EQ.0 .AND. I4.EQ.0) THEN 
                CALL SDX_UUX_H(P,H1,H2,ANS1)
                CALL SDX_UCX_H(P,H1,H2,ANS2)
                CALL SDX_SDX_H(P,H1,H2,ANS3)
                CALL SDX_CUX_H(P,H1,H2,ANS4)
		CALL SDX_CCX_H(P,H1,H2,ANS5)
                ANS=ANS1+ANS2+ANS3+ANS4+ANS5
            ENDIF
      ELSE IF(KEY.EQ.0) THEN 
          IF(I3.EQ.2 .AND. I4.EQ.-2) CALL SDX_UUX_NOH(P,H1,H2,ANS)
          IF(I3.EQ.2 .AND. I4.EQ.-4) CALL SDX_UCX_NOH(P,H1,H2,ANS)
          IF(I3.EQ.3 .AND. I4.EQ.-1) CAll SDX_SDX_NOH(P,H1,H2,ANS)
          IF(I3.EQ.4 .AND. I4.EQ.-2) CALL SDX_CUX_NOH(P,H1,H2,ANS)
 	  IF(I3.EQ.4 .AND. I4.EQ.-4) CALL SDX_CCX_NOH(P,H1,H2,ANS)
             IF(I3.EQ.0 .AND. I4.EQ.0) THEN 
                 CALL SDX_UUX_NOH(P,H1,H2,ANS1)
                 CALL SDX_UCX_NOH(P,H1,H2,ANS2)
                 CALL SDX_SDX_NOH(P,H1,H2,ANS3)
                 CALL SDX_CUX_NOH(P,H1,H2,ANS4)
 		 CALL SDX_CCX_NOH(P,H1,H2,ANS5)
                 ANS=ANS1+ANS2+ANS3+ANS4+ANS5
...
C ----- begin subprocesses  SDX->jjH  with Higgs->tautau

      SUBROUTINE SDX_UUX_H(P,H1,H2,ANS)
C     
...
C     
C     Process: s d~ > u u~ h WEIGHTED=6
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SDX_UUX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SDX_UUX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
c==========================================
      ...
      SUBROUTINE SDX_UCX_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s d~ > u c~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SDX_UCX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SDX_UCX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C===============================================
      ...
      SUBROUTINE SDX_SDX_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s d~ > s d~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SDX_SDX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SDX_SDX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C======================================== 
      ...
      SUBROUTINE SDX_CUX_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s d~ > c u~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SDX_CUX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SDX_CUX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 1
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_SDX_CUX_H=MATRIX
      ENDIF
      ENDIF
      END


      SUBROUTINE SDX_CCX_H(P,H1,H2,ANS)
C
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s d~ > c c~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SDX_CCX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SDX_CCX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 1
	  ...
	  MATRIX_SDX_CCX_H=MATRIX
	  ENDIF
	  ENDIF
	  END

C  ---  end of subprocess SDX->jjH, H->tautau

C ----- begin subprocesses SDX->jjtautau, no Higgs

      SUBROUTINE SDX_UUX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s d~ > u u~ ta+ ta- / h Qed=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SDX_UUX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SDX_UUX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 11
     ...
     $ +AMP(9)+AMP(10)+AMP(11)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_SDX_UUX_NOH=MATRIX
      ENDIF                ! CLOSES H1 IF 
      ENDIF                ! CLOSES H2 IF
      END


      SUBROUTINE SDX_UCX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s d~ > u c~ ta+ ta- / h Qed=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SDX_UCX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SDX_UCX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 11
     ...
     $ +AMP(9)+AMP(10)+AMP(11)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_SDX_UCX_NOH=MATRIX
      ENDIF                ! CLOSES H1 IF 
      ENDIF                ! CLOSES H2 IF
      END

      SUBROUTINE SDX_SDX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s d~ > s d~ ta+ ta- / h Qed=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SDX_SDX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SDX_SDX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 32
     ...
     $ -1./6.*AMP(27)-1./6.*AMP(28)+AMP(29)+AMP(30)+AMP(31)+AMP(32)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_SDX_SDX_NOH=MATRIX
      ENDIF                ! CLOSES H1 IF 
      ENDIF                ! CLOSES H2 IF
      END


      SUBROUTINE SDX_CUX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s d~ > c u~ ta+ ta- / h Qed=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SDX_CUX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SDX_CUX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 11
     ...
     $ +AMP(9)+AMP(10)+AMP(11)
      ...
      SUBROUTINE SDX_CCX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s d~ > c c~ ta+ ta- / h Qed=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SDX_CCX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SDX_CCX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 11
     ...
     $ +AMP(9)+AMP(10)+AMP(11)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_SDX_CCX_NOH=MATRIX
      ENDIF                ! CLOSES H1 IF 
      ENDIF                ! CLOSES H2 IF
      END
	  
C  ------- end subprocesses SDX->jjtautau, no Higgs
