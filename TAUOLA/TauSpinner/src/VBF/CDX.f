c ---------------------   subprocesses initiated by CDbar
 
      SUBROUTINE  CDX(P,I3,I4,H1,H2,KEY,ANS)
      IMPLICIT NONE
...
C  FINAL CSX IS EQUAL TO FINAL UDX 

      IF(KEY.EQ.1) THEN
         IF(I3.EQ.2 .AND. I4.EQ.-1) CALL CDX_UDX_H(P,H1,H2,ANS)
         IF(I3.EQ.2 .AND. I4.EQ.-3) CALL CDX_USX_H(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.-1) CAll CDX_CDX_H(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.-3) CALL CDX_UDX_H(P,H1,H2,ANS)
            IF(I3.EQ.0 .AND. I4.EQ.0) THEN 
                CALL CDX_UDX_H(P,H1,H2,ANS1)
                CALL CDX_USX_H(P,H1,H2,ANS2)
                CALL CDX_CDX_H(P,H1,H2,ANS3)
                CALL CDX_UDX_H(P,H1,H2,ANS4)
                ANS=ANS1+ANS2+ANS3+ANS4
            ENDIF
      ELSE IF(KEY.EQ.0) THEN 
         IF(I3.EQ.2 .AND. I4.EQ.-1) CALL CDX_UDX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.2 .AND. I4.EQ.-3) CALL CDX_USX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.-1) CAll CDX_CDX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.-3) CALL CDX_UDX_NOH(P,H1,H2,ANS)
            IF(I3.EQ.0 .AND. I4.EQ.0) THEN 
                CALL CDX_UDX_NOH(P,H1,H2,ANS1)
                CALL CDX_USX_NOH(P,H1,H2,ANS2)
                CALL CDX_CDX_NOH(P,H1,H2,ANS3)
                CALL CDX_UDX_NOH(P,H1,H2,ANS4)
                ANS=ANS1+ANS2+ANS3+ANS4
            ENDIF   
      ELSE 
		   WRITE(*,*) 'NOT FINISHED'
...
C ----- begin subprocesses  CDX->UDX  with Higgs->tautau


      SUBROUTINE CDX_UDX_H(P,H1,H2,ANS)
C     
...
C     
C     Process: c d~ > u d~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     Process: c d~ > c s~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CDX_UDX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CDX_UDX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 1
      ...
      ENDDO
      MATRIX_CDX_UDX_H=MATRIX
      ENDIF
      ENDIF
      END

C ----- begin subprocesses  CDX->CDX  with Higgs->tautau

      SUBROUTINE CDX_CDX_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: c d~ > c d~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CDX_CDX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CDX_CDX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 2
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_CDX_CDX_H=MATRIX
      ENDIF
      ENDIF
      END

C ----- begin subprocesses  CDX->USX  with Higgs->tautau

      SUBROUTINE CDX_USX_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: c d~ > u s~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CDX_USX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CDX_USX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 1
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_CDX_USX_H=MATRIX
      ENDIF
      ENDIF
      END

C ----- begin subprocesses  CDX->CSX  with Higgs->tautau
C ----- THE SAME AS         CDX->UDX  WITH Higgs->tautau

C     -------------- NOW PROCESSIS WITHOUT HIGGS

C ----- begin subprocesses  CDX->UDX  NO Higgs

      SUBROUTINE CDX_UDX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: c d~ > u d~ ta+ ta- / h QED=4
C     Process: c d~ > c s~ ta+ ta- / h QED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CDX_UDX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CDX_UDX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 11
     ...
     $ -AMP(9)-AMP(10)-AMP(11)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_CDX_UDX_NOH=MATRIX
      ENDIF
      ENDIF
      END

C ----- begin subprocesses  CDX->CDX  NO Higgs

      SUBROUTINE CDX_CDX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: c d~ > c d~ ta+ ta- / h QED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CDX_CDX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CDX_CDX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 43
     ...
     $ +AMP(38)+AMP(39)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_CDX_CDX_NOH=MATRIX
      ENDIF
      ENDIF
      END

C ----- begin subprocesses  CDX->USX  NO Higgs

      SUBROUTINE CDX_USX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: c d~ > u s~ ta+ ta- / h QED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CDX_USX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CDX_USX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 11
     ...
     $ -AMP(9)-AMP(10)-AMP(11)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_CDX_USX_NOH=MATRIX
      ENDIF
      ENDIF
      END

C ----- begin subprocesses  CDX->CSX  NO Higgs
C  IS THE SAME AS CDX->UDX NO Higgs
