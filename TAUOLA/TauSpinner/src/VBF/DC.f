...
c ---------------------   subprocesses initiated by DC:      27.10.2015
 
      SUBROUTINE  DC(P,I3,I4,H1,H2,KEY,ANS)
      IMPLICIT NONE
...
C      I3=0,2 OR 4             I4=0,1 OR 3
      ...
      IF(KEY.EQ.1) THEN
         IF(I3.EQ.2 .AND. I4.EQ.1) CALL DC_UD_H(P,H1,H2,ANS)
         IF(I3.EQ.2 .AND. I4.EQ.3) CALL DC_US_H(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.1) CAll DC_CD_H(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.3) CALL DC_CS_H(P,H1,H2,ANS)
            IF(I3.EQ.0 .AND. I4.EQ.0) THEN 
                CALL DC_UD_H(P,H1,H2,ANS1)
                CALL DC_US_H(P,H1,H2,ANS2)
                CALL DC_CD_H(P,H1,H2,ANS3)
                CALL DC_CS_H(P,H1,H2,ANS4)
                ANS=ANS1+ANS2+ANS3+ANS4
            ENDIF
      ELSE IF(KEY.EQ.0) THEN 
         IF(I3.EQ.2 .AND. I4.EQ.1) CALL DC_UD_NOH(P,H1,H2,ANS)
         IF(I3.EQ.2 .AND. I4.EQ.3) CALL DC_US_NOH(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.1) CAll DC_CD_NOH(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.3) CALL DC_CS_NOH(P,H1,H2,ANS)
            IF(I3.EQ.0 .AND. I4.EQ.0) THEN 
                CALL DC_UD_NOH(P,H1,H2,ANS1)
                CALL DC_US_NOH(P,H1,H2,ANS2)
                CALL DC_CD_NOH(P,H1,H2,ANS3)
                CALL DC_CS_NOH(P,H1,H2,ANS4)
                ANS=ANS1+ANS2+ANS3+ANS4
            ENDIF   
      ELSE 
		   WRITE(*,*) 'NOT FINISHED'
...
C ----- begin subprocesses  DC->jjH  with Higgs->tautau

      SUBROUTINE DC_CD_H(P,H1,H2,ANS)
C     
...
C     
C     Process: d c > c d h WEIGHTED=6
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_DC_CD_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_DC_CD_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      CALL FFV2_3(W(1,2),W(1,4),GC_44,MW,WW,W(1,5))
...
c==========================================
      ...
      SUBROUTINE DC_CS_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: d c > c s h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_DC_CS_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_DC_CS_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C===============================================
      ...
      SUBROUTINE DC_UD_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: d c > u d h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_DC_UD_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_DC_UD_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      CALL FFV2_3(W(1,2),W(1,4),GC_44,MW,WW,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL VVS1_0(W(1,3),W(1,6),W(1,7),GC_72,AMP(1))
      JAMP(1)=-AMP(1)
...
C======================================== 
      ...
      SUBROUTINE DC_US_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: d c > u s h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_DC_US_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_DC_US_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C  ---  end of subprocess DC->jjH, H->tautau

C ----- begin subprocesses DC->jjtautau, no Higgs

      SUBROUTINE DC_CD_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: d c > c d ta+ ta- / h QED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_DC_CD_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_DC_CD_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      CALL FFV2_3(W(1,2),W(1,4),GC_44,MW,WW,W(1,8))
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV2_2(W(1,2),W(1,7),GC_44,ZERO,ZERO,W(1,11))
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,11),W(1,4),W(1,9),GC_1,AMP(4))
      CALL FFV2_1(W(1,4),W(1,7),GC_44,ZERO,ZERO,W(1,12))
...
C     Amplitude(s) for diagram number 41
      CALL FFV2_0(W(1,12),W(1,3),W(1,8),GC_44,AMP(41))
...
C     Amplitude(s) for diagram number 43
      CALL FFV2_0(W(1,15),W(1,3),W(1,8),GC_44,AMP(43))
     ...
     $ +AMP(38)+AMP(39)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_DC_CD_NOH=MATRIX
      ENDIF                ! CLOSES H1 IF 
      ENDIF                ! CLOSES H2 IF
      END


      SUBROUTINE DC_CS_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: d c > c s ta+ ta- / h QED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_DC_CS_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_DC_CS_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 11
     ...
     $ -AMP(9)-AMP(10)-AMP(11)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_DC_CS_NOH=MATRIX
      ENDIF                ! CLOSES H1 IF 
      ENDIF                ! CLOSES H2 IF
      END

      SUBROUTINE DC_UD_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: d c > u d ta+ ta- / h QED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_DC_UD_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_DC_UD_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 4
      CALL FFV1_0(W(1,6),W(1,4),W(1,9),GC_1,AMP(4))
      CALL FFV2_1(W(1,4),W(1,7),GC_44,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,2),W(1,5),W(1,9),GC_2,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_3_0(W(1,6),W(1,4),W(1,10),GC_50,GC_58,AMP(6))
...
C     Amplitude(s) for diagram number 11
     ...
     $ -AMP(9)-AMP(10)-AMP(11)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_DC_UD_NOH=MATRIX
      ENDIF                ! CLOSES H1 IF 
      ENDIF                ! CLOSES H2 IF
      END


      SUBROUTINE DC_US_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: d c > u s ta+ ta- / h QED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_DC_US_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_DC_US_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 11
     ...
     $ -AMP(9)-AMP(10)-AMP(11)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_DC_US_NOH=MATRIX
      ENDIF                ! CLOSES H1 IF 
      ENDIF                ! CLOSES H2 IF
      END


C  ------- end subprocesses DC->jjtautau, no Higgs
C DONE 27.10.2015
