C ---------  begin processes initiated by SSbar

      SUBROUTINE  SSX(P,I3,I4,H1,H2,KEY,ANS)
      IMPLICIT NONE
 
      INTEGER I3,I4,   H1,H2,   KEY
      REAL*8 P(0:3,6), ANS, ANS1,ANS2,ANS3,ANS4, ANS5,ANS6,ANS7

C      I3=0,1,2,3 OR 4,              I4=0,-1,-2,-3, OR -4, 
C  OR I3=21 AND I4=21  GLUONS
	   
      ANS=0.D0

      IF(KEY.EQ.1) THEN
         IF(I3.EQ.1 .AND. I4.EQ.-1) CALL SSX_DDX_H(P,H1,H2,ANS)
         IF(I3.EQ.2 .AND. I4.EQ.-2) CALL SSX_UUX_H(P,H1,H2,ANS)
         IF(I3.EQ.3 .AND. I4.EQ.-3) CAll SSX_SSX_H(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.-4) CALL SSX_CCX_H(P,H1,H2,ANS)
         IF(I3.EQ.2 .AND. I4.EQ.-4) CALL SSX_UCX_H(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.-2) CALL SSX_CUX_H(P,H1,H2,ANS)
            IF(I3.EQ.0 .AND. I4.EQ.0) THEN 
                CALL SSX_DDX_H(P,H1,H2,ANS1)
                CALL SSX_UUX_H(P,H1,H2,ANS2)
                CALL SSX_SSX_H(P,H1,H2,ANS3)
                CALL SSX_CCX_H(P,H1,H2,ANS4)
                CALL SSX_UCX_H(P,H1,H2,ANS5)
                CALL SSX_CUX_H(P,H1,H2,ANS6)
                ANS=ANS1+ANS2+ANS3+ANS4+ANS5+ANS6
            ENDIF
      ELSE IF(KEY.EQ.0) THEN 
         IF(I3.EQ.1 .AND. I4.EQ.-1) CALL SSX_DDX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.2 .AND. I4.EQ.-2) CALL SSX_UUX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.3 .AND. I4.EQ.-3) CAll SSX_SSX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.-4) CALL SSX_CCX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.2 .AND. I4.EQ.-4) CALL SSX_UCX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.-2) CALL SSX_CUX_NOH(P,H1,H2,ANS)
		 IF(I3.EQ.21.AND.I4.EQ.21) CALL SSX_GG_NOH(P,H1,H2,ANS)
            IF(I3.EQ.0 .AND. I4.EQ.0) THEN 
                CALL SSX_DDX_NOH(P,H1,H2,ANS1)
                CALL SSX_UUX_NOH(P,H1,H2,ANS2)
                CALL SSX_SSX_NOH(P,H1,H2,ANS3)
                CALL SSX_CCX_NOH(P,H1,H2,ANS4)
                CALL SSX_UCX_NOH(P,H1,H2,ANS5)
                CALL SSX_CUX_NOH(P,H1,H2,ANS6)
				CALL SSX_GG_NOH(P,H1,H2,ANS7)
...
C ----- begin subprocesses  SSX->DDX  with Higgs->tautau

      SUBROUTINE SSX_DDX_H(P,H1,H2,ANS)
C     
...
C     
C     Process: s s~ > d d~ h WEIGHTED=6
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SSX_DDX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SSX_DDX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 1
      ...
      ENDDO
      MATRIX_SSX_DDX_H=MATRIX
      ENDIF
      ENDIF
      END

C ----- begin subprocesses  SSX->UUX  with Higgs->tautau

      SUBROUTINE SSX_UUX_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s s~ > u u~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SSX_UUX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SSX_UUX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 2
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_SSX_UUX_H=MATRIX
      ENDIF
      ENDIF
      END

C ----- begin subprocesses  SSX->SSX  with Higgs->tautau

      SUBROUTINE SSX_SSX_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s s~ > s s~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SSX_SSX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SSX_SSX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 2
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_SSX_SSX_H=MATRIX
      ENDIF
      ENDIF 
      END

C ----- begin subprocesses  SSX->CCX  with Higgs->tautau

      SUBROUTINE SSX_CCX_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s s~ > c c~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SSX_CCX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SSX_CCX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 2
      ...
      MATRIX_SSX_CCX_H=MATRIX
      ENDIF
      ENDIF
      END

C ----- begin subprocesses  SSX->UCX  with Higgs->tautau

      SUBROUTINE SSX_UCX_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s s~ > u c~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SSX_UCX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SSX_UCX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 1
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_SSX_UCX_H=MATRIX
      ENDIF
      ENDIF
      END

C ------- BEFFINING SUBPROCESS SSX->CUX with H->tautau 

      SUBROUTINE SSX_CUX_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s s~ > c u~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SSX_CUX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SSX_CUX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 1
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_SSX_CUX_H=MATRIX
      ENDIF
      ENDIF
      END

CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C ----- begin subprocesses SS->jjtautau, no Higgs

C-----------SUBPROCESS SSX->DDX NO HIGGS

      SUBROUTINE SSX_DDX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s s~ > d d~ ta+ ta- / h Qed=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SSX_DDX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SSX_DDX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 32
     ...
     $ -AMP(27)-AMP(28))
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_SSX_DDX_NOH=MATRIX
      ENDIF
      ENDIF
      END

C-----------SUBPROCESS SSX->UUX NO HIGGS

      SUBROUTINE SSX_UUX_NOH(P,H1,H2,ANS)
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
C     
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s s~ > u u~ ta+ ta- / h Qed=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SSX_UUX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SSX_UUX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 24
      ...
      CALL FFV2_2(W(1,4),W(1,9),GC_101,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 25
...
C     Amplitude(s) for diagram number 27
      ...
      CALL FFV2_2(W(1,1),W(1,14),GC_101,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 28
...
C     Amplitude(s) for diagram number 31
      CALL FFV2_0(W(1,5),W(1,3),W(1,14),GC_101,AMP(31))
...
C     Amplitude(s) for diagram number 43
     ...
     $ -1./2.*AMP(38)-1./2.*AMP(39)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_SSX_UUX_NOH=MATRIX
      ENDIF
      ENDIF 
      END

C-----------SUBPROCESS SSX->SSX NO HIGGS

      SUBROUTINE SSX_SSX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s s~ > s s~ ta+ ta- / h Qed=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SSX_SSX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SSX_SSX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 64
     ...
     $ -1./2.*AMP(60)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_SSX_SSX_NOH=MATRIX
      ENDIF
      ENDIF
      END

C-----------SUBPROCESS SSX->CCX NO HIGGS

      SUBROUTINE SSX_CCX_NOH(P,H1,H2,ANS)
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s s~ > c c~ ta+ ta- / h Qed=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SSX_CCX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SSX_CCX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 43
     ...
     $ -1./2.*AMP(38)-1./2.*AMP(39)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_SSX_CCX_NOH=MATRIX
      ENDIF
      ENDIF
      END

C -----------------SUBPROCESS SSX->UCX, NO HIGGS

      SUBROUTINE SSX_UCX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s s~ > u c~ ta+ ta- / h Qed=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SSX_UCX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SSX_UCX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 11
     ...
     $ +AMP(9)+AMP(10)+AMP(11)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_SSX_UCX_NOH=MATRIX
      ENDIF
      ENDIF
      END

C ----------------SUBPROCESS SSX->CUX, NO HIGGS

      SUBROUTINE SSX_CUX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s s~ > c u~ ta+ ta- / h Qed=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SSX_CUX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SSX_CUX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 11
     ...
     $ +AMP(9)+AMP(10)+AMP(11)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_SSX_CUX_NOH=MATRIX
      ENDIF
      ENDIF
      END
	  

      SUBROUTINE SSX_GG_NOH(P,H1,H2,ANS)	  
C
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_SSX_GG_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_SSX_GG_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,5),W(1,6),GC_3,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 1
      CALL FFV1_0(W(1,7),W(1,8),W(1,9),GC_1,AMP(1))
      CALL FFV2_4_3(W(1,5),W(1,6),GC_50,GC_59,MZ,WZ,W(1,10))
C     Amplitude(s) for diagram number 2
      CALL FFV2_3_0(W(1,7),W(1,8),W(1,10),GC_50,GC_58,AMP(2))
...
C     Amplitude(s) for diagram number 5
      CALL FFV1_0(W(1,6),W(1,7),W(1,9),GC_1,AMP(5))
C     Amplitude(s) for diagram number 6
      CALL FFV2_3_0(W(1,6),W(1,7),W(1,10),GC_50,GC_58,AMP(6))
      CALL FFV1_2(W(1,6),W(1,3),GC_11,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,5),W(1,2),W(1,9),GC_1,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_3_0(W(1,5),W(1,2),W(1,10),GC_50,GC_58,AMP(8))
      CALL FFV1_2(W(1,1),W(1,9),GC_1,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,5),W(1,7),W(1,4),GC_11,AMP(9))
      CALL FFV2_3_2(W(1,1),W(1,10),GC_50,GC_58,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 10
...
C     Amplitude(s) for diagram number 12
      ...
      CALL FFV1_2(W(1,1),W(1,8),GC_11,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,4),W(1,2),W(1,9),GC_1,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,5),W(1,2),W(1,8),GC_11,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV2_3_0(W(1,4),W(1,2),W(1,10),GC_50,GC_58,AMP(15))
C     Amplitude(s) for diagram number 16
     ...
     $ *AMP(13)+IMAG1*AMP(14)+IMAG1*AMP(15)+IMAG1*AMP(16)
      ...
      MATRIX_SSX_GG_NOH=MATRIX
      ENDIF
      ENDIF
      END
	  
C   END SUBROUTINE SSX	  
