c ---------------------   subprocesses initiated by USbar
 
      SUBROUTINE  USX(P,I3,I4,H1,H2,KEY,ANS)
      IMPLICIT NONE
...
C  FINAL CSX IS EQUAL TO FINAL UDX 
      ...
      IF(KEY.EQ.1) THEN
         IF(I3.EQ.2 .AND. I4.EQ.-1) CALL USX_UDX_H(P,H1,H2,ANS)
         IF(I3.EQ.2 .AND. I4.EQ.-3) CALL USX_USX_H(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.-1) CAll USX_CDX_H(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.-3) CALL USX_UDX_H(P,H1,H2,ANS)
            IF(I3.EQ.0 .AND. I4.EQ.0) THEN 
                CALL USX_UDX_H(P,H1,H2,ANS1)
                CALL USX_USX_H(P,H1,H2,ANS2)
                CALL USX_CDX_H(P,H1,H2,ANS3)
                CALL USX_UDX_H(P,H1,H2,ANS4)
                ANS=ANS1+ANS2+ANS3+ANS4
            ENDIF
      ELSE IF(KEY.EQ.0) THEN 
         IF(I3.EQ.2 .AND. I4.EQ.-1) CALL USX_UDX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.2 .AND. I4.EQ.-3) CALL USX_USX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.-1) CAll USX_CDX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.-3) CALL USX_UDX_NOH(P,H1,H2,ANS)
            IF(I3.EQ.0 .AND. I4.EQ.0) THEN 
                CALL USX_UDX_NOH(P,H1,H2,ANS1)
                CALL USX_USX_NOH(P,H1,H2,ANS2)
                CALL USX_CDX_NOH(P,H1,H2,ANS3)
                CALL USX_UDX_NOH(P,H1,H2,ANS4)
                ANS=ANS1+ANS2+ANS3+ANS4
            ENDIF   
      ELSE 
		   WRITE(*,*) 'NOT FINISHED'
...
C ----- begin subprocesses  USX->UDX  with Higgs->tautau


      SUBROUTINE USX_UDX_H(P,H1,H2,ANS)
C     
...
C     
C     Process: u s~ > u d~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     Process: u s~ > c s~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_USX_UDX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_USX_UDX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 1
      ...
      MATRIX_USX_UDX_H=MATRIX
      ENDIF
      ENDIF
      END

C ----- begin subprocesses  USX->USX  with Higgs->tautau

      SUBROUTINE USX_USX_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: u s~ > u s~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_USX_USX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_USX_USX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 2
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_USX_USX_H=MATRIX
      ENDIF
      ENDIF
      END

C ----- begin subprocesses  USX->CDX  with Higgs->tautau

      SUBROUTINE USX_CDX_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: u s~ > c d~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_USX_CDX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_USX_CDX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 1
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_USX_CDX_H=MATRIX
      ENDIF
      ENDIF
      END

C ----- begin subprocesses  USX->CSX  with Higgs->tautau
C ----- THE SAME AS         USX->UDX  WITH Higgs->tautau

C     -------------- NOW PROCESSIS WITHOUT HIGGS

C ----- begin subprocesses  USX->UDX  NO Higgs

      SUBROUTINE USX_UDX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: u s~ > u d~ ta+ ta- / h QED=4
C     Process: u s~ > c s~ ta+ ta- / h QED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_USX_UDX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_USX_UDX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 11
     ...
     $ -AMP(9)-AMP(10)-AMP(11)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_USX_UDX_NOH=MATRIX
      ENDIF
      ENDIF
      END

C ----- begin subprocesses  USX->USX  NO Higgs

      SUBROUTINE USX_USX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: u s~ > u s~ ta+ ta- / h QED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_USX_USX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_USX_USX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 43
     ...
     $ +AMP(38)+AMP(39)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_USX_USX_NOH=MATRIX
      ENDIF
      ENDIF
      END

C ----- begin subprocesses  USX->CDX  NO Higgs

      SUBROUTINE USX_CDX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: u s~ > c d~ ta+ ta- / h QED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_USX_CDX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ...
      REAL*8 FUNCTION MATRIX_USX_CDX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 11
     ...
     $ -AMP(9)-AMP(10)-AMP(11)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_USX_CDX_NOH=MATRIX
      ENDIF
      ENDIF
      END

C ----- begin subprocesses  USX->CSX  NO Higgs
C  IS THE SAME AS USX->CSX NO Higgs



C   DONE 25.10.2015   STILL S=2 MISSING
