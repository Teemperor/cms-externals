c uux_uux_noH corrected 30.11.2015 by JK
C ---------  begin processes initiated by UUbar
...
C OR I3=21 AND I4=21  -> GLUONS AS FINAL JETS
      ...
      IF(KEY.EQ.1) THEN
         IF(I3.EQ.1 .AND. I4.EQ.-1) CALL UUX_DDX_H(P,H1,H2,ANS)
         IF(I3.EQ.2 .AND. I4.EQ.-2) CALL UUX_UUX_H(P,H1,H2,ANS)
         IF(I3.EQ.3 .AND. I4.EQ.-3) CAll UUX_SSX_H(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.-4) CALL UUX_CCX_H(P,H1,H2,ANS)
         IF(I3.EQ.1 .AND. I4.EQ.-3) CALL UUX_DSX_H(P,H1,H2,ANS)
         IF(I3.EQ.3 .AND. I4.EQ.-1) CALL UUX_SDX_H(P,H1,H2,ANS)

         IF(I3.EQ.-1 .AND. I4.EQ.1) CALL UUX_DDX_H(PP,H1,H2,ANS)
         IF(I3.EQ.-2 .AND. I4.EQ.2) CALL UUX_UUX_H(PP,H1,H2,ANS)
         IF(I3.EQ.-3 .AND. I4.EQ.3) CAll UUX_SSX_H(PP,H1,H2,ANS)
         IF(I3.EQ.-4 .AND. I4.EQ.4) CALL UUX_CCX_H(PP,H1,H2,ANS)
         IF(I3.EQ.-3 .AND. I4.EQ.1) CALL UUX_DSX_H(PP,H1,H2,ANS)
         IF(I3.EQ.-1 .AND. I4.EQ.3) CALL UUX_SDX_H(PP,H1,H2,ANS)
            IF(I3.EQ.0 .AND. I4.EQ.0) THEN 
                CALL UUX_DDX_H(P,H1,H2,ANS1)
                CALL UUX_UUX_H(P,H1,H2,ANS2)
                CALL UUX_SSX_H(P,H1,H2,ANS3)
                CALL UUX_CCX_H(P,H1,H2,ANS4)
                CALL UUX_DSX_H(P,H1,H2,ANS5)
                CALL UUX_SDX_H(P,H1,H2,ANS6)
                ANS=ANS1+ANS2+ANS3+ANS4+ANS5+ANS6
                CALL UUX_DDX_H(PP,H1,H2,ANS1)
                CALL UUX_UUX_H(PP,H1,H2,ANS2)
                CALL UUX_SSX_H(PP,H1,H2,ANS3)
                CALL UUX_CCX_H(PP,H1,H2,ANS4)
                CALL UUX_DSX_H(PP,H1,H2,ANS5)
                CALL UUX_SDX_H(PP,H1,H2,ANS6)
                ANS=ANS1+ANS2+ANS3+ANS4+ANS5+ANS6+ANS
            ENDIF
      ELSE IF(KEY.EQ.0) THEN 
         IF(I3.EQ.1 .AND. I4.EQ.-1) CALL UUX_DDX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.2 .AND. I4.EQ.-2) CALL UUX_UUX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.3 .AND. I4.EQ.-3) CAll UUX_SSX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.4 .AND. I4.EQ.-4) CALL UUX_CCX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.1 .AND. I4.EQ.-3) CALL UUX_DSX_NOH(P,H1,H2,ANS)
         IF(I3.EQ.3 .AND. I4.EQ.-1) CALL UUX_SDX_NOH(P,H1,H2,ANS)

         IF(I3.EQ.21 .AND .I4.EQ.21) CALL UUX_GG_NOH(P,H1,H2,ANS)

         IF(I3.EQ.-1 .AND. I4.EQ.1) CALL UUX_DDX_NOH(PP,H1,H2,ANS)
         IF(I3.EQ.-2 .AND. I4.EQ.2) CALL UUX_UUX_NOH(PP,H1,H2,ANS)
         IF(I3.EQ.-3 .AND. I4.EQ.3) CAll UUX_SSX_NOH(PP,H1,H2,ANS)
         IF(I3.EQ.-4 .AND. I4.EQ.4) CALL UUX_CCX_NOH(PP,H1,H2,ANS)
         IF(I3.EQ.-3 .AND. I4.EQ.1) CALL UUX_DSX_NOH(PP,H1,H2,ANS)
         IF(I3.EQ.-1 .AND. I4.EQ.3) CALL UUX_SDX_NOH(PP,H1,H2,ANS)

            IF(I3.EQ.0 .AND. I4.EQ.0) THEN 
                CALL UUX_DDX_NOH(P,H1,H2,ANS1)
                CALL UUX_UUX_NOH(P,H1,H2,ANS2)
                CALL UUX_SSX_NOH(P,H1,H2,ANS3)
                CALL UUX_CCX_NOH(P,H1,H2,ANS4)
                CALL UUX_DSX_NOH(P,H1,H2,ANS5)
                CALL UUX_SDX_NOH(P,H1,H2,ANS6)
                ANS=ANS1+ANS2+ANS3+ANS4+ANS5+ANS6
                CALL UUX_DDX_NOH(PP,H1,H2,ANS1)
                CALL UUX_UUX_NOH(PP,H1,H2,ANS2)
                CALL UUX_SSX_NOH(PP,H1,H2,ANS3)
                CALL UUX_CCX_NOH(PP,H1,H2,ANS4)
                CALL UUX_DSX_NOH(PP,H1,H2,ANS5)
                CALL UUX_SDX_NOH(PP,H1,H2,ANS6)
                ANS=ANS1+ANS2+ANS3+ANS4+ANS5+ANS6+ANS
                CALL UUX_GG_NOH(P,H1,H2,ANS1)
                ANS=ANS1+ANS
            ENDIF   
      ELSE
           WRITE(*,*) 'NOT FINISHED'
...
C ----- begin subprocesses  UUX->DDX  with Higgs->tautau

      SUBROUTINE UUX_DDX_H(P,H1,H2,ANS)
C     
...
C     
C     Process: u u~ > d d~ h WEIGHTED=6
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_UUX_DDX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_UUX_DDX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 2
      ...
      ENDDO
      MATRIX_UUX_DDX_H=MATRIX
      ENDIF
      ENDIF
      END

C ----- begin subprocesses  UUX->UUX  with Higgs->tautau

      SUBROUTINE UUX_UUX_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: u u~ > u u~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_UUX_UUX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_UUX_UUX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 2
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_UUX_UUX_H=MATRIX
      ENDIF
      ENDIF
      END

C ----- begin subprocesses  UUX->SSX  with Higgs->tautau

      SUBROUTINE UUX_SSX_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: u u~ > s s~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_UUX_SSX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_UUX_SSX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 1
      CALL VVS1_0(W(1,6),W(1,5),W(1,7),GC_81,AMP(1))
      CALL FFV2_3(W(1,1),W(1,3),GC_101,MW,WW,W(1,5))
...
C     Amplitude(s) for diagram number 2
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_UUX_SSX_H=MATRIX
      ENDIF
      ENDIF
      END

C ----- begin subprocesses  UUX->CCX  with Higgs->tautau

      SUBROUTINE UUX_CCX_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: u u~ > c c~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_UUX_CCX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_UUX_CCX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 1
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_UUX_CCX_H=MATRIX
      ENDIF
      ENDIF
      END

C ----- begin subprocesses  UUX->DSX  with Higgs->tautau

      SUBROUTINE UUX_DSX_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: u u~ > d s~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_UUX_DSX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_UUX_DSX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 1
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_UUX_DSX_H=MATRIX
      ENDIF
      ENDIF
      END

C ----- begin subprocesses  UUX->SDX  with Higgs->tautau

      SUBROUTINE UUX_SDX_H(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: u u~ > s d~ h WEIGHTED=6
C     *   Decay: h > ta+ ta- WEIGHTED=2
C     
      IMPLICIT NONE
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_UUX_SDX_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_UUX_SDX_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 1
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_UUX_SDX_H=MATRIX
      ENDIF
      ENDIF
      END

CCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCCC
C ----------- SUBPROCESSES FOR UUX->jjtautau, no Higgs

c -----------SUBPROCESS UUX->DDX, NO HIGGS

      SUBROUTINE UUX_DDX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: u u~ > d d~ ta+ ta- / h QED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_UUX_DDX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_UUX_DDX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 43
     ...
     $ -1./2.*AMP(38)-1./2.*AMP(39)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_UUX_DDX_NOH=MATRIX
      ENDIF
      ENDIF
      END

c -----------SUBPROCESS UUX->UUX, NO HIGGS

      SUBROUTINE UUX_UUX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: u u~ > u u~ ta+ ta- / h QED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_UUX_UUX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_UUX_UUX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 64
     ...
     $ -1./2.*AMP(60)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_UUX_UUX_NOH=MATRIX
      ENDIF
      ENDIF
      END

c -----------SUBPROCESS UUX->SSX, NO HIGGS

      SUBROUTINE UUX_SSX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: u u~ > s s~ ta+ ta- / h QED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_UUX_SSX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_UUX_SSX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 20
      CALL FFV2_3_0(W(1,9),W(1,3),W(1,7),GC_50,GC_58,AMP(20))
      CALL FFV2_3(W(1,1),W(1,3),GC_101,MW,WW,W(1,9))
      CALL FFV2_3(W(1,4),W(1,2),GC_101,MW,WW,W(1,14))
      CALL FFV2_2(W(1,5),W(1,9),GC_108,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 21
      CALL FFV2_0(W(1,10),W(1,6),W(1,14),GC_108,AMP(21))
C     Amplitude(s) for diagram number 22
...
C     Amplitude(s) for diagram number 23
      CALL VVV1_0(W(1,9),W(1,14),W(1,7),GC_53,AMP(23))
      CALL FFV2_1(W(1,2),W(1,9),GC_101,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,4),W(1,10),W(1,12),GC_1,AMP(24))
      CALL FFV2_2(W(1,4),W(1,9),GC_101,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 25
      CALL FFV1_0(W(1,6),W(1,2),W(1,12),GC_2,AMP(25))
C     Amplitude(s) for diagram number 26
      CALL FFV2_3_0(W(1,4),W(1,10),W(1,7),GC_50,GC_58,AMP(26))
C     Amplitude(s) for diagram number 27
      CALL FFV2_5_0(W(1,6),W(1,2),W(1,7),GC_51,GC_58,AMP(27))
      CALL FFV2_2(W(1,1),W(1,14),GC_101,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 28
      CALL FFV1_0(W(1,6),W(1,3),W(1,12),GC_1,AMP(28))
      CALL FFV1_2(W(1,1),W(1,12),GC_2,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 29
      CALL FFV2_0(W(1,10),W(1,3),W(1,14),GC_101,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV2_3_0(W(1,6),W(1,3),W(1,7),GC_50,GC_58,AMP(30))
      CALL FFV2_5_2(W(1,1),W(1,7),GC_51,GC_58,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 31
      CALL FFV2_0(W(1,6),W(1,3),W(1,14),GC_101,AMP(31))
      CALL FFV1_2(W(1,1),W(1,8),GC_2,ZERO,ZERO,W(1,14))
C     Amplitude(s) for diagram number 32
      CALL FFV1_0(W(1,14),W(1,2),W(1,12),GC_2,AMP(32))
C     Amplitude(s) for diagram number 33
...
C     Amplitude(s) for diagram number 43
     ...
     $ -1./2.*AMP(38)-1./2.*AMP(39)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_UUX_SSX_NOH=MATRIX
      ENDIF
      ENDIF
      END

c -----------SUBPROCESS UUX->CCX, NO HIGGS

      SUBROUTINE UUX_CCX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: u u~ > c c~ ta+ ta- / h QED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_UUX_CCX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_UUX_CCX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 32
     ...
     $ -AMP(27)-AMP(28))
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_UUX_CCX_NOH=MATRIX
      ENDIF
      ENDIF
      END

c -----------SUBPROCESS UUX->DSX, NO HIGGS

      SUBROUTINE UUX_DSX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: u u~ > d s~ ta+ ta- / h QED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_UUX_DSX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_UUX_DSX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 11
     ...
     $ +AMP(9)+AMP(10)+AMP(11)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_UUX_DSX_NOH=MATRIX
      ENDIF
      ENDIF
      END

c -----------SUBPROCESS UUX->SDX, NO HIGGS

      SUBROUTINE UUX_SDX_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: u u~ > s d~ ta+ ta- / h QED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_UUX_SDX_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_UUX_SDX_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.12, 2013-08-21
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 11
     ...
     $ +AMP(9)+AMP(10)+AMP(11)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_UUX_SDX_NOH=MATRIX
      ENDIF
      ENDIF
      END

C  DONE 19.11.2014.  STILL  NEEDS S=2 IMPLEMENTATION

C ------------------------------------------------------
C    WITH GLUONS AS JETS ADDED 9.07.2015

C  --- BEGIN SUBROUTINE UUX->GG NO HIGGS

      SUBROUTINE UUX_GG_NOH(P,H1,H2,ANS)
C     
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: u u~ > g g ta+ ta- / h QED=4
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_UUX_GG_NOH(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_UUX_GG_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV2_4_3(W(1,5),W(1,6),GC_50,GC_59,MZ,WZ,W(1,7))
C     Amplitude(s) for diagram number 3
      CALL FFV2_5_0(W(1,1),W(1,9),W(1,7),GC_51,GC_58,AMP(3))
C     Amplitude(s) for diagram number 4
      CALL FFV2_5_0(W(1,10),W(1,2),W(1,7),GC_51,GC_58,AMP(4))
...
C     Amplitude(s) for diagram number 7
      CALL FFV1_0(W(1,1),W(1,6),W(1,8),GC_2,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV2_5_0(W(1,1),W(1,6),W(1,7),GC_51,GC_58,AMP(8))
...
C     Amplitude(s) for diagram number 11
      CALL FFV1_0(W(1,5),W(1,2),W(1,8),GC_2,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV2_5_0(W(1,5),W(1,2),W(1,7),GC_51,GC_58,AMP(12))
      CALL FFV1_1(W(1,10),W(1,3),GC_11,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,1),W(1,5),W(1,8),GC_2,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV2_5_0(W(1,1),W(1,5),W(1,7),GC_51,GC_58,AMP(14))
      CALL FFV1_2(W(1,9),W(1,3),GC_11,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 15
      CALL FFV1_0(W(1,5),W(1,2),W(1,8),GC_2,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV2_5_0(W(1,5),W(1,2),W(1,7),GC_51,GC_58,AMP(16))
