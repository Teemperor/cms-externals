C  JK.  poprawka 10.11.2015
c------------------begin subprocess initiated by CU----------

      SUBROUTINE  CU(P,I3,I4,H1,H2,KEY,ANS)
      IMPLICIT NONE
 
      INTEGER I3,I4,   H1,H2,   KEY
      REAL*8 P(0:3,6), ANS

C      I3=0,2             I4=0,4    ! only CU->UC
      
      ANS=0.D0

      IF(KEY.EQ.1) THEN
         IF(I3.EQ.2 .AND. I4.EQ.4) CALL CU_UC_H(P,H1,H2,ANS)
         IF(I3.EQ.0 .AND. I4.EQ.0) CALL CU_UC_H(P,H1,H2,ANS)
      ELSE IF(KEY.EQ.0) THEN 
         IF(I3.EQ.2 .AND. I4.EQ.4) CALL CU_UC_NOH(P,H1,H2,ANS)
         IF(I3.EQ.0 .AND. I4.EQ.0) CALL CU_UC_NOH(P,H1,H2,ANS)
      ELSE 
...
C ---------begin subprocess CU->jjH with H-> tautau
c   ---------------------jj=CU only -------------

      SUBROUTINE CU_UC_H(P,H1,H2,ANS)
C     
...
C     
C     Process: c u > u c h WEIGHTED=6
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CU_UC_H(P ,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CU_UC_H(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      CALL FFV2_5_3(W(1,1),W(1,4),GC_51,GC_58,MZ,WZ,W(1,6))
...
C     Amplitude(s) for diagram number 1
      ...
      ENDDO
      MATRIX_CU_UC_H=MATRIX
      ENDIF
      ENDIF
      END
C----------------end subprocess CU->jjH---------

c----------------begin subprocess CU->jj_noH

   

      SUBROUTINE CU_UC_NOH(P,H1,H2,ANS)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: c u > u c ta+ ta- / h QED=4
C     
      IMPLICIT NONE
C     
C     CONSTANTS
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
          T=MATRIX_CU_UC_NOH(P,H1,H2,NHEL(1,IHEL),JC(1))
          ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_CU_UC_NOH(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph 5 v. 1.5.15, 2013-12-11
C     By the MadGraph Development Team
C     Please visit us at https://launchpad.net/madgraph5
...
C     ----------
      ...
      CALL FFV1P0_3(W(1,2),W(1,3),GC_2,ZERO,ZERO,W(1,8))
...
C     Amplitude(s) for diagram number 9
      CALL FFV1_0(W(1,9),W(1,3),W(1,12),GC_2,AMP(9))
      CALL FFV1_1(W(1,3),W(1,7),GC_2,ZERO,ZERO,W(1,13))
C     Amplitude(s) for diagram number 10
      CALL FFV1_0(W(1,2),W(1,13),W(1,12),GC_2,AMP(10))
      CALL FFV2_4_3(W(1,5),W(1,6),GC_50,GC_59,MZ,WZ,W(1,7))
C     Amplitude(s) for diagram number 11
      CALL FFV2_5_0(W(1,9),W(1,3),W(1,7),GC_51,GC_58,AMP(11))
...
C     Amplitude(s) for diagram number 13
      CALL FFV1_0(W(1,9),W(1,3),W(1,12),GC_2,AMP(13))
      CALL FFV1_1(W(1,3),W(1,13),GC_11,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 14
      CALL FFV1_0(W(1,2),W(1,6),W(1,12),GC_2,AMP(14))
C     Amplitude(s) for diagram number 15
      CALL FFV2_5_0(W(1,9),W(1,3),W(1,7),GC_51,GC_58,AMP(15))
C     Amplitude(s) for diagram number 16
      CALL FFV2_5_0(W(1,2),W(1,6),W(1,7),GC_51,GC_58,AMP(16))
      CALL FFV2_5_2(W(1,2),W(1,10),GC_51,GC_58,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 17
      CALL FFV1_0(W(1,6),W(1,3),W(1,12),GC_2,AMP(17))
      CALL FFV2_5_1(W(1,3),W(1,10),GC_51,GC_58,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 18
      CALL FFV1_0(W(1,2),W(1,9),W(1,12),GC_2,AMP(18))
C     Amplitude(s) for diagram number 19
      CALL FFV2_5_0(W(1,6),W(1,3),W(1,7),GC_51,GC_58,AMP(19))
C     Amplitude(s) for diagram number 20
      CALL FFV2_5_0(W(1,2),W(1,9),W(1,7),GC_51,GC_58,AMP(20))
      CALL FFV1_2(W(1,1),W(1,8),GC_2,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 21
      CALL FFV1_0(W(1,9),W(1,4),W(1,12),GC_2,AMP(21))
      CALL FFV1_2(W(1,1),W(1,12),GC_2,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 22
      CALL FFV1_0(W(1,6),W(1,4),W(1,8),GC_2,AMP(22))
C     Amplitude(s) for diagram number 23
      CALL FFV2_5_0(W(1,9),W(1,4),W(1,7),GC_51,GC_58,AMP(23))
      CALL FFV2_5_2(W(1,1),W(1,7),GC_51,GC_58,ZERO,ZERO,W(1,9))
C     Amplitude(s) for diagram number 24
      CALL FFV1_0(W(1,9),W(1,4),W(1,8),GC_2,AMP(24))
...
C     Amplitude(s) for diagram number 29
      CALL FFV1_0(W(1,8),W(1,4),W(1,12),GC_2,AMP(29))
C     Amplitude(s) for diagram number 30
      CALL FFV2_5_0(W(1,6),W(1,4),W(1,11),GC_51,GC_58,AMP(30))
C     Amplitude(s) for diagram number 31
      CALL FFV2_5_0(W(1,8),W(1,4),W(1,7),GC_51,GC_58,AMP(31))
C     Amplitude(s) for diagram number 32
      CALL FFV2_5_0(W(1,9),W(1,4),W(1,11),GC_51,GC_58,AMP(32))
     ...
     $ -1./6.*AMP(27)-1./6.*AMP(28)+AMP(29)+AMP(30)+AMP(31)+AMP(32)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_CU_UC_NOH=MATRIX
      ENDIF
      ENDIF
      END
    
C -------------end subprocess initiated by CU---------
C DONE 26.10.2015, poprawka 10.11.2015
