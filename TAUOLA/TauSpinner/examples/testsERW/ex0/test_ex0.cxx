...
int main(int argc, char **argv) {
  ...
  while(true) {
    ...
    WT=1.0; // ignore weight for validation of events sample
#endif

#ifdef _USE_MCTESTER_
    // For MC-TESTER analysis we use event defined in TauSpinner/src/read_HepMC
    HepMC::GenEvent *mc_tester_event = read_HepMC_getEvent();
...
#ifdef _SPIN_VALIDATION_ONLY_
  cout<<"WT not used when filling histograms: "<<endl;
#endif

  char outname[500]="test.root";
