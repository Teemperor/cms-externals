C  MB. corrected 23.12.2016     
      SUBROUTINE cd_s2(P,I3,I4,H1,H2,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     ----------
      ANS=0.D0
      IF(I3.EQ.4 .AND. I4.EQ.1) CALL cd_cd_s2(P,H1,H2,ANS)
      IF(I3.EQ.4 .AND. I4.EQ.3) CALL cd_cs_s2(P,H1,H2,ANS)
      IF(I3.EQ.2 .AND. I4.EQ.1) CALL cd_ud_s2(P,H1,H2,ANS)
      IF(I3.EQ.2 .AND. I4.EQ.3) CALL cd_us_s2(P,H1,H2,ANS)
      

      END

      SUBROUTINE cd_cd_s2(P,H1,H2,ANS)
C     
...
C     
C     Process: c d > c d x QED<=99 NPqq<=99 NPll<=99 QCD<=99 NPgg<=99
C      NPVV<=99 @1
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_cd_cd_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_cd_cd_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 6
      CALL FFV4_0_S(W(1,8),W(1,4),W(1,6),GC_1,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV4_0_S(W(1,8),W(1,4),W(1,9),GC_7,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV5_6_0(W(1,8),W(1,4),W(1,10),GC_42,GC_39,AMP(8))
      CALL FFT4_5_1(W(1,4),W(1,7),GC_12,GC_13,ZERO,ZERO,W(1,5))
C     Amplitude(s) for diagram number 9
      CALL FFV4_0_S(W(1,2),W(1,5),W(1,6),GC_1,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV4_0_S(W(1,2),W(1,5),W(1,9),GC_7,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV5_6_0(W(1,2),W(1,5),W(1,10),GC_42,GC_39,AMP(11))
      CALL FFV5_3_S(W(1,1),W(1,4),GC_59,MW,WW,W(1,10))
      CALL FFV5_3_S(W(1,2),W(1,3),GC_29,MW,WW,W(1,4))
C     Amplitude(s) for diagram number 12
      CALL VVT2_0(W(1,10),W(1,4),W(1,7),GC_16,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV5_0_S(W(1,8),W(1,3),W(1,10),GC_29,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV5_0_S(W(1,1),W(1,5),W(1,4),GC_59,AMP(14))
     ...
     $ +AMP(13)+AMP(14)
      ...
      ENDDO
      MATRIX_cd_cd_s2=MATRIX
      ENDIF
      ENDIF
      END
     
      SUBROUTINE cd_cs_s2(P,H1,H2,ANS)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: c d > c s x QED<=99 NPqq<=99 NPll<=99 QCD<=99 NPgg<=99
C      NPVV<=99 @1
C     *   Decay: x > ta+ ta- WEIGHTED<=1
C     
      IMPLICIT NONE
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_cd_cs_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_cd_cs_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL OXXXXX_S(P(0,6),MTA,NHEL(6),+1*IC(6),W(1,6))
      CALL FFT4_5_3(W(1,5),W(1,6),GC_14,GC_15,MX2,WX2,W(1,7))
      CALL FFV5_3_S(W(1,1),W(1,4),GC_60,MW,WW,W(1,6))
      CALL FFV5_3_S(W(1,2),W(1,3),GC_29,MW,WW,W(1,4))
C     Amplitude(s) for diagram number 1
      CALL VVT2_0(W(1,6),W(1,4),W(1,7),GC_16,AMP(1))
      CALL FFT4_5_2(W(1,2),W(1,7),GC_12,GC_13,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 2
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_cd_cs_s2=MATRIX
      ENDIF
      ENDIF
      END
     
      SUBROUTINE cd_ud_s2(P,H1,H2,ANS)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: c d > u d x QED<=99 NPqq<=99 NPll<=99 QCD<=99 NPgg<=99
C      NPVV<=99 @1
C     *   Decay: x > ta+ ta- WEIGHTED<=1
C     
      IMPLICIT NONE
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_cd_ud_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_cd_ud_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL OXXXXX_S(P(0,6),MTA,NHEL(6),+1*IC(6),W(1,6))
      CALL FFT4_5_3(W(1,5),W(1,6),GC_14,GC_15,MX2,WX2,W(1,7))
      CALL FFV5_3_S(W(1,1),W(1,4),GC_59,MW,WW,W(1,6))
...
C     Amplitude(s) for diagram number 4
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_cd_ud_s2=MATRIX
      ENDIF
      ENDIF
      END
  

      SUBROUTINE cd_us_s2(P,H1,H2,ANS)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: c d > u s x QED<=99 NPqq<=99 NPll<=99 QCD<=99 NPgg<=99
C      NPVV<=99 @1
C     *   Decay: x > ta+ ta- WEIGHTED<=1
C     
      IMPLICIT NONE
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_cd_us_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_cd_us_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL FFT4_5_3(W(1,5),W(1,6),GC_14,GC_15,MX2,WX2,W(1,7))
      CALL FFV5_3_S(W(1,1),W(1,4),GC_60,MW,WW,W(1,6))
      CALL FFV5_3_S(W(1,2),W(1,3),GC_26,MW,WW,W(1,4))
C     Amplitude(s) for diagram number 1
      CALL VVT2_0(W(1,6),W(1,4),W(1,7),GC_16,AMP(1))
      CALL FFT4_5_2(W(1,2),W(1,7),GC_12,GC_13,ZERO,ZERO,W(1,4))
C     Amplitude(s) for diagram number 2
...
C     Amplitude(s) for diagram number 3
      CALL FFV5_0_S(W(1,2),W(1,4),W(1,6),GC_26,AMP(3))
