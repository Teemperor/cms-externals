C  MB. corrected 23.12.2016      
      SUBROUTINE cs_s2(P,I3,I4,H1,H2,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     ----------
      ANS=0.D0
      IF(I3.EQ.4 .AND. I4.EQ.1) CALL cs_cd_s2(P,H1,H2,ANS)
      IF(I3.EQ.4 .AND. I4.EQ.3) CALL cs_cs_s2(P,H1,H2,ANS)
      IF(I3.EQ.2 .AND. I4.EQ.1) CALL cs_ud_s2(P,H1,H2,ANS)
      IF(I3.EQ.2 .AND. I4.EQ.3) CALL cs_us_s2(P,H1,H2,ANS)
   

      END

      SUBROUTINE cs_cd_s2(P,H1,H2,ANS)
C     
...
C     
C     Process: c s > c d x QED<=99 NPqq<=99 NPll<=99 QCD<=99 NPgg<=99
C      NPVV<=99 @1
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_cs_cd_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_cs_cd_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 2
      ...
      ENDDO
      MATRIX_cs_cd_s2=MATRIX
      ENDIF
      ENDIF
      END
     
      SUBROUTINE cs_cs_s2(P,H1,H2,ANS)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: c s > c s x QED<=99 NPqq<=99 NPll<=99 QCD<=99 NPgg<=99
C      NPVV<=99 @1
C     *   Decay: x > ta+ ta- WEIGHTED<=1
C     
      IMPLICIT NONE
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_cs_cs_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_cs_cs_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV5_6_3(W(1,1),W(1,3),GC_43,GC_40,MZ,WZ,W(1,9))
C     Amplitude(s) for diagram number 4
      CALL VVT2_0(W(1,5),W(1,9),W(1,7),GC_46,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL VVT2_0(W(1,9),W(1,8),W(1,7),GC_48,AMP(5))
      CALL FFV5_3_S(W(1,1),W(1,4),GC_60,MW,WW,W(1,9))
      CALL FFV5_3_S(W(1,2),W(1,3),GC_30,MW,WW,W(1,4))
C     Amplitude(s) for diagram number 6
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_cs_cs_s2=MATRIX
      ENDIF
      ENDIF
      END
     

      SUBROUTINE cs_ud_s2(P,H1,H2,ANS)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: c s > u d x QED<=99 NPqq<=99 NPll<=99 QCD<=99 NPgg<=99
C      NPVV<=99 @1
C     *   Decay: x > ta+ ta- WEIGHTED<=1
C     
      IMPLICIT NONE
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_cs_ud_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_cs_ud_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 3
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_cs_ud_s2=MATRIX
      ENDIF
      ENDIF
      END
     

      SUBROUTINE cs_us_s2(P,H1,H2,ANS)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: c s > u s x QED<=99 NPqq<=99 NPll<=99 QCD<=99 NPgg<=99
C      NPVV<=99 @1
C     *   Decay: x > ta+ ta- WEIGHTED<=1
C     
      IMPLICIT NONE
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_cs_us_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_cs_us_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
