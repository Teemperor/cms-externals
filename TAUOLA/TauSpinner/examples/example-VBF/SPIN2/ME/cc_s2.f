C  MB. corrected 23.12.2016   
      SUBROUTINE cc_s2(P,I3,I4,H1,H2,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     BEGIN CODE
C     ----------
      IF(I3.EQ.4 .AND. I4.EQ.4)CALL cc_cc_s2(P,H1,H2,ANS)

      END

      SUBROUTINE cc_cc_s2(P,H1,H2,ANS)
C     
...
C     
C     Process: c c > c c x QED<=99 NPqq<=99 NPll<=99 QCD<=99 NPgg<=99
C      NPVV<=99 @1
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_cc_cc_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_cc_cc_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV4P0_3(W(1,1),W(1,4),GC_2,ZERO,ZERO,W(1,9))
      CALL FFV4P0_3(W(1,2),W(1,3),GC_2,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 6
      CALL VVT2_0(W(1,9),W(1,8),W(1,7),GC_49,AMP(6))
      CALL FFV5_6_3(W(1,2),W(1,3),GC_43,GC_40,MZ,WZ,W(1,5))
C     Amplitude(s) for diagram number 7
      CALL VVT2_0(W(1,9),W(1,5),W(1,7),GC_46,AMP(7))
      CALL FFV4P0_3(W(1,1),W(1,4),GC_7,ZERO,ZERO,W(1,9))
      CALL FFV4P0_3(W(1,2),W(1,3),GC_7,ZERO,ZERO,W(1,6))
C     Amplitude(s) for diagram number 8
      CALL VVT2_0(W(1,9),W(1,6),W(1,7),GC_9,AMP(8))
      CALL FFV5_6_3(W(1,1),W(1,4),GC_43,GC_40,MZ,WZ,W(1,6))
