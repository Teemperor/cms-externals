C  MB. corrected 23.12.2016
      SUBROUTINE csx_s2(P,I3,I4,H1,H2,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     BEGIN CODE
C     ----------
      IF(I3.EQ.4 .AND. I4.EQ.-1) CALL csx_cdx_s2(P,H1,H2,ANS)
      IF(I3.EQ.4 .AND. I4.EQ.-3) CALL csx_csx_s2(P,H1,H2,ANS)
      IF(I3.EQ.2 .AND. I4.EQ.-1) CALL csx_udx_s2(P,H1,H2,ANS)
      IF(I3.EQ.2 .AND. I4.EQ.-3) CALL csx_usx_s2(P,H1,H2,ANS)
      

      END

      SUBROUTINE csx_cdx_s2(P,H1,H2,ANS)
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_csx_cdx_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_csx_cdx_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL FFV5_3_S(W(1,1),W(1,2),GC_60,MW,WW,W(1,6))
      CALL FFV5_3_S(W(1,4),W(1,3),GC_29,MW,WW,W(1,2))
C     Amplitude(s) for diagram number 1
      CALL VVT2_0(W(1,6),W(1,2),W(1,7),GC_16,AMP(1))
      CALL FFT4_5_2(W(1,4),W(1,7),GC_12,GC_13,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 2
      CALL FFV5_0_S(W(1,2),W(1,3),W(1,6),GC_29,AMP(2))
      JAMP(1)=-AMP(1)-AMP(2)
      ...
      ENDDO
      MATRIX_csx_cdx_s2=MATRIX
      ENDIF
      ENDIF
      END
   

      SUBROUTINE csx_csx_s2(P,H1,H2,ANS)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_csx_csx_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_csx_csx_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 5
      ...
      CALL FFV5_3_S(W(1,1),W(1,2),GC_60,MW,WW,W(1,9))
      CALL FFV5_3_S(W(1,4),W(1,3),GC_30,MW,WW,W(1,2))
C     Amplitude(s) for diagram number 6
      CALL VVT2_0(W(1,9),W(1,2),W(1,7),GC_16,AMP(6))
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_csx_csx_s2=MATRIX
      ENDIF
      ENDIF
      END
    

      SUBROUTINE csx_udx_s2(P,H1,H2,ANS)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_csx_udx_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_csx_udx_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL FFT4_5_3(W(1,5),W(1,6),GC_14,GC_15,MX2,WX2,W(1,7))
      CALL FFV5_3_S(W(1,1),W(1,2),GC_60,MW,WW,W(1,6))
      CALL FFV5_3_S(W(1,4),W(1,3),GC_26,MW,WW,W(1,2))
C     Amplitude(s) for diagram number 1
      CALL VVT2_0(W(1,6),W(1,2),W(1,7),GC_16,AMP(1))
      CALL FFT4_5_2(W(1,4),W(1,7),GC_12,GC_13,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 2
      CALL FFV5_0_S(W(1,2),W(1,3),W(1,6),GC_26,AMP(2))
      CALL FFT4_5_1(W(1,3),W(1,7),GC_12,GC_13,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 3
      CALL FFV5_0_S(W(1,4),W(1,2),W(1,6),GC_26,AMP(3))
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_csx_udx_s2=MATRIX
      ENDIF
      ENDIF
      END
    
      SUBROUTINE csx_usx_s2(P,H1,H2,ANS)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_csx_usx_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_csx_usx_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL FFT4_5_3(W(1,5),W(1,6),GC_14,GC_15,MX2,WX2,W(1,7))
      CALL FFV5_3_S(W(1,1),W(1,2),GC_60,MW,WW,W(1,6))
      CALL FFV5_3_S(W(1,4),W(1,3),GC_27,MW,WW,W(1,2))
C     Amplitude(s) for diagram number 1
      CALL VVT2_0(W(1,6),W(1,2),W(1,7),GC_16,AMP(1))
      CALL FFT4_5_1(W(1,3),W(1,7),GC_12,GC_13,ZERO,ZERO,W(1,2))
C     Amplitude(s) for diagram number 2
      CALL FFV5_0_S(W(1,4),W(1,2),W(1,6),GC_27,AMP(2))
      JAMP(1)=-AMP(1)-AMP(2)
