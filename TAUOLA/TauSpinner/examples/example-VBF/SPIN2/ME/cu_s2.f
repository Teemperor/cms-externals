C  MB. corrected 23.12.2016
      SUBROUTINE cu_s2(P,I3,I4,H1,H2,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     BEGIN CODE
C     ----------
      IF(I3.EQ.2 .AND. I4.EQ.4)CALL cu_uc_s2(P,H1,H2,ANS)

      END

      SUBROUTINE cu_uc_s2(P,H1,H2,ANS)
C     
...
C     
C     Process: c u > u c x QED<=99 NPqq<=99 NPll<=99 QCD<=99 NPgg<=99
C      NPvv<=99 @1
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_cu_uc_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_cu_uc_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL FFV4P0_3(W(1,1),W(1,4),GC_2,ZERO,ZERO,W(1,6))
      CALL FFV4P0_3(W(1,2),W(1,3),GC_2,ZERO,ZERO,W(1,5))
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFV4P0_3(W(1,1),W(1,4),GC_7,ZERO,ZERO,W(1,9))
      CALL FFV4P0_3(W(1,2),W(1,3),GC_7,ZERO,ZERO,W(1,10))
C     Amplitude(s) for diagram number 3
      CALL VVT2_0(W(1,9),W(1,10),W(1,7),GC_9,AMP(3))
      CALL FFV5_6_3(W(1,1),W(1,4),GC_43,GC_40,MZ,WZ,W(1,10))
...
C     Amplitude(s) for diagram number 6
      CALL FFV4_0_S(W(1,8),W(1,3),W(1,6),GC_2,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL FFV4_0_S(W(1,8),W(1,3),W(1,9),GC_7,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV5_6_0(W(1,8),W(1,3),W(1,10),GC_43,GC_40,AMP(8))
      CALL FFT4_5_1(W(1,3),W(1,7),GC_12,GC_13,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 9
      CALL FFV4_0_S(W(1,2),W(1,8),W(1,6),GC_2,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV4_0_S(W(1,2),W(1,8),W(1,9),GC_7,AMP(10))
C     Amplitude(s) for diagram number 11
      CALL FFV5_6_0(W(1,2),W(1,8),W(1,10),GC_43,GC_40,AMP(11))
