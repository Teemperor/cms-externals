C  MB. corrected 23.12.2016
      SUBROUTINE scx_s2(P,I3,I4,H1,H2,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     BEGIN CODE
C     ----------
      IF(I3.EQ.1 .AND. I4.EQ.-4) CALL scx_dcx_s2(P,H1,H2,ANS)
      IF(I3.EQ.1 .AND. I4.EQ.-2) CALL scx_dux_s2(P,H1,H2,ANS)
      IF(I3.EQ.3 .AND. I4.EQ.-4) CALL scx_scx_s2(P,H1,H2,ANS)
      IF(I3.EQ.3 .AND. I4.EQ.-2) CALL scx_sux_s2(P,H1,H2,ANS)
      

      END

      SUBROUTINE scx_dcx_s2(P,H1,H2,ANS)
C     
...
C     
C     Process: s c~ > d c~ x QED<=99 NPqq<=99 NPll<=99 QCD<=99
C      NPgg<=99 NPVV<=99 @1
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_scx_dcx_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_scx_dcx_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL FFV5_3_S(W(1,1),W(1,2),GC_30,MW,WW,W(1,5))
...
C     Amplitude(s) for diagram number 2
      ...
      ENDDO
      MATRIX_scx_dcx_s2=MATRIX
      ENDIF
      ENDIF
      END
      

      SUBROUTINE scx_dux_s2(P,H1,H2,ANS)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s c~ > d u~ x QED<=99 NPqq<=99 NPll<=99 QCD<=99
C      NPgg<=99 NPVV<=99 @1
C     *   Decay: x > ta+ ta- WEIGHTED<=1
C     
      IMPLICIT NONE
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_scx_dux_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_scx_dux_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 3
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_scx_dux_s2=MATRIX
      ENDIF
      ENDIF
      END
      
      SUBROUTINE scx_scx_s2(P,H1,H2,ANS)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s c~ > s c~ x QED<=99 NPqq<=99 NPll<=99 QCD<=99
C      NPgg<=99 NPVV<=99 @1
C     *   Decay: x > ta+ ta- WEIGHTED<=1
C     
      IMPLICIT NONE
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_scx_scx_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_scx_scx_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV5_6_3(W(1,4),W(1,2),GC_43,GC_40,MZ,WZ,W(1,9))
C     Amplitude(s) for diagram number 4
      CALL VVT2_0(W(1,5),W(1,9),W(1,7),GC_46,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL VVT2_0(W(1,9),W(1,8),W(1,7),GC_48,AMP(5))
      CALL FFV5_3_S(W(1,4),W(1,3),GC_60,MW,WW,W(1,9))
      CALL FFV5_3_S(W(1,1),W(1,2),GC_30,MW,WW,W(1,4))
C     Amplitude(s) for diagram number 6
      CALL VVT2_0(W(1,9),W(1,4),W(1,7),GC_16,AMP(6))
      JAMP(1)=+1D0/2D0*AMP(3)-AMP(6)
      JAMP(2)=+AMP(1)+AMP(2)-1D0/6D0*AMP(3)+AMP(4)+AMP(5)
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_scx_scx_s2=MATRIX
      ENDIF
      ENDIF
      END
     
      SUBROUTINE scx_sux_s2(P,H1,H2,ANS)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s c~ > s u~ x QED<=99 NPqq<=99 NPll<=99 QCD<=99
C      NPgg<=99 NPVV<=99 @1
C     *   Decay: x > ta+ ta- WEIGHTED<=1
C     
      IMPLICIT NONE
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_scx_sux_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_scx_sux_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
