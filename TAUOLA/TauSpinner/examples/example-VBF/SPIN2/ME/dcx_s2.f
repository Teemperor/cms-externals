C  MB. corrected 23.12.2016
      SUBROUTINE dcx_s2(P,I3,I4,H1,H2,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     BEGIN CODE
C     ----------
      IF(I3.EQ.1 .AND. I4.EQ.-4) CALL dcx_dcx_s2(P,H1,H2,ANS)
      IF(I3.EQ.1 .AND. I4.EQ.-2) CALL dcx_dux_s2(P,H1,H2,ANS)
      IF(I3.EQ.3 .AND. I4.EQ.-4) CALL dcx_scx_s2(P,H1,H2,ANS)
      IF(I3.EQ.3 .AND. I4.EQ.-2) CALL dcx_sux_s2(P,H1,H2,ANS)
     

      END

      SUBROUTINE dcx_dcx_s2(P,H1,H2,ANS)
C     
...
C     
C     Process: d c~ > d c~ x QED<=99 NPqq<=99 NPll<=99 QCD<=99
C      NPgg<=99 NPVV<=99 @1
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_dcx_dcx_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_dcx_dcx_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV5_6_3(W(1,4),W(1,2),GC_43,GC_40,MZ,WZ,W(1,10))
...
C     Amplitude(s) for diagram number 11
      ...
      CALL FFV5_3_S(W(1,4),W(1,3),GC_59,MW,WW,W(1,10))
      CALL FFV5_3_S(W(1,1),W(1,2),GC_29,MW,WW,W(1,3))
C     Amplitude(s) for diagram number 12
      CALL VVT2_0(W(1,10),W(1,3),W(1,7),GC_16,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV5_0_S(W(1,8),W(1,2),W(1,10),GC_29,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV5_0_S(W(1,4),W(1,5),W(1,3),GC_59,AMP(14))
     ...
     $ /6D0*AMP(7)+AMP(8)+AMP(9)-1D0/6D0*AMP(10)+AMP(11)
      ...
      ENDDO
      MATRIX_dcx_dcx_s2=MATRIX
      ENDIF
      ENDIF
      END
      SUBROUTINE dcx_dux_s2(P,H1,H2,ANS)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: d c~ > d u~ x QED<=99 NPqq<=99 NPll<=99 QCD<=99
C      NPgg<=99 NPVV<=99 @1
C     *   Decay: x > ta+ ta- WEIGHTED<=1
C     
      IMPLICIT NONE
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_dcx_dux_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_dcx_dux_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL FFV5_3_S(W(1,1),W(1,2),GC_29,MW,WW,W(1,5))
C     Amplitude(s) for diagram number 1
      CALL VVT2_0(W(1,6),W(1,5),W(1,7),GC_16,AMP(1))
      CALL FFT4_5_2(W(1,1),W(1,7),GC_12,GC_13,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 2
      CALL FFV5_0_S(W(1,8),W(1,2),W(1,6),GC_29,AMP(2))
...
C     Amplitude(s) for diagram number 4
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_dcx_dux_s2=MATRIX
      ENDIF
      ENDIF
      END
      

      SUBROUTINE dcx_scx_s2(P,H1,H2,ANS)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: d c~ > s c~ x QED<=99 NPqq<=99 NPll<=99 QCD<=99
C      NPgg<=99 NPVV<=99 @1
C     *   Decay: x > ta+ ta- WEIGHTED<=1
C     
      IMPLICIT NONE
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_dcx_scx_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_dcx_scx_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 2
      ...
      DO I = 1, NCOLOR
        ...
        MATRIX = MATRIX+ZTEMP*DCONJG(JAMP(I))/DENOM(I)
      ENDDO
      MATRIX_dcx_scx_s2=MATRIX
      ENDIF
      ENDIF
      END
      

      SUBROUTINE dcx_sux_s2(P,H1,H2,ANS)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: d c~ > s u~ x QED<=99 NPqq<=99 NPll<=99 QCD<=99
C      NPgg<=99 NPVV<=99 @1
C     *   Decay: x > ta+ ta- WEIGHTED<=1
C     
      IMPLICIT NONE
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_dcx_sux_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_dcx_sux_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 2
      ...
      CALL FFT4_5_2(W(1,4),W(1,7),GC_12,GC_13,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 3
      CALL FFV5_0_S(W(1,8),W(1,3),W(1,5),GC_57,AMP(3))
