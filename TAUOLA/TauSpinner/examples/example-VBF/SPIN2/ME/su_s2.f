C  MB. corrected 23.12.2016
      SUBROUTINE su_s2(P,I3,I4,H1,H2,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     ----------
      ...
      IF(I3.EQ.2 .AND. I4.EQ.3) CALL su_us_s2(P,H1,H2,ANS)
      IF(I3.EQ.4 .AND. I4.EQ.1) CALL su_cd_s2(P,H1,H2,ANS)
      IF(I3.EQ.4 .AND. I4.EQ.3) CALL su_cs_s2(P,H1,H2,ANS)
      IF(I3.EQ.2 .AND. I4.EQ.1) CALL su_ud_s2(P,H1,H2,ANS)
      END
      SUBROUTINE su_us_s2(P,H1,H2,ANS)
C     
...
C     
C     Process: s u > u s x QED<=99 NPqq<=99 NPll<=99 QCD<=99 NPgg<=99
C      NPvv<=99 @1
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_su_us_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_su_us_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL FFV5_3_S(W(1,1),W(1,3),GC_27,MW,WW,W(1,6))
...
C     Amplitude(s) for diagram number 3
      CALL VVT2_0(W(1,6),W(1,9),W(1,7),GC_49,AMP(3))
      CALL FFV5_6_3(W(1,2),W(1,3),GC_43,GC_40,MZ,WZ,W(1,10))
C     Amplitude(s) for diagram number 4
      CALL VVT2_0(W(1,6),W(1,10),W(1,7),GC_46,AMP(4))
      CALL FFV4P0_3(W(1,1),W(1,4),GC_7,ZERO,ZERO,W(1,11))
      CALL FFV4P0_3(W(1,2),W(1,3),GC_7,ZERO,ZERO,W(1,12))
C     Amplitude(s) for diagram number 5
      CALL VVT2_0(W(1,11),W(1,12),W(1,7),GC_9,AMP(5))
      CALL FFV5_6_3(W(1,1),W(1,4),GC_42,GC_39,MZ,WZ,W(1,12))
C     Amplitude(s) for diagram number 6
      CALL VVT2_0(W(1,9),W(1,12),W(1,7),GC_46,AMP(6))
C     Amplitude(s) for diagram number 7
      CALL VVT2_0(W(1,12),W(1,10),W(1,7),GC_48,AMP(7))
C     Amplitude(s) for diagram number 8
      CALL FFV4_0_S(W(1,8),W(1,3),W(1,6),GC_2,AMP(8))
C     Amplitude(s) for diagram number 9
      CALL FFV4_0_S(W(1,8),W(1,3),W(1,11),GC_7,AMP(9))
C     Amplitude(s) for diagram number 10
      CALL FFV5_6_0(W(1,8),W(1,3),W(1,12),GC_43,GC_40,AMP(10))
      CALL FFT4_5_1(W(1,3),W(1,7),GC_12,GC_13,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 11
      CALL FFV4_0_S(W(1,2),W(1,8),W(1,6),GC_2,AMP(11))
C     Amplitude(s) for diagram number 12
      CALL FFV4_0_S(W(1,2),W(1,8),W(1,11),GC_7,AMP(12))
C     Amplitude(s) for diagram number 13
      CALL FFV5_6_0(W(1,2),W(1,8),W(1,12),GC_43,GC_40,AMP(13))
C     Amplitude(s) for diagram number 14
      CALL FFV5_0_S(W(1,1),W(1,8),W(1,5),GC_27,AMP(14))
      JAMP(1)=-AMP(1)-AMP(2)+1D0/2D0*AMP(5)+1D0/2D0*AMP(9)+1D0/2D0
     $ *AMP(12)-AMP(14)
      JAMP(2)=+AMP(3)+AMP(4)-1D0/6D0*AMP(5)+AMP(6)+AMP(7)+AMP(8)-1D0
     $ /6D0*AMP(9)+AMP(10)+AMP(11)-1D0/6D0*AMP(12)+AMP(13)
      ...
      ENDDO
      MATRIX_su_us_s2=MATRIX
      ENDIF
      ENDIF
      END
      
      SUBROUTINE su_cd_s2(P,H1,H2,ANS)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s u > c d x QED<=99 NPqq<=99 NPll<=99 QCD<=99 NPgg<=99
C      NPvv<=99 @1
C     *   Decay: x > ta+ ta- WEIGHTED<=1
C     
      IMPLICIT NONE
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_su_cd_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_su_cd_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL OXXXXX_S(P(0,6),MTA,NHEL(6),+1*IC(6),W(1,6))
      CALL FFT4_5_3(W(1,5),W(1,6),GC_14,GC_15,MX2,WX2,W(1,7))
      CALL FFV5_3_S(W(1,1),W(1,3),GC_30,MW,WW,W(1,6))
      CALL FFV5_3_S(W(1,2),W(1,4),GC_56,MW,WW,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL VVT2_0(W(1,3),W(1,6),W(1,7),GC_16,AMP(1))
      CALL FFT4_5_2(W(1,2),W(1,7),GC_12,GC_13,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL FFV5_0_S(W(1,3),W(1,4),W(1,6),GC_56,AMP(2))
      CALL FFT4_5_1(W(1,4),W(1,7),GC_12,GC_13,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 3
      CALL FFV5_0_S(W(1,2),W(1,3),W(1,6),GC_56,AMP(3))
      ...
      SUBROUTINE su_cs_s2(P,H1,H2,ANS)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s u > c s x QED<=99 NPqq<=99 NPll<=99 QCD<=99 NPgg<=99
C      NPvv<=99 @1
C     *   Decay: x > ta+ ta- WEIGHTED<=1
C     
      IMPLICIT NONE
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_su_cs_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_su_cs_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     ----------
      ...
      CALL FFT4_5_3(W(1,5),W(1,6),GC_14,GC_15,MX2,WX2,W(1,7))
      CALL FFV5_3_S(W(1,1),W(1,3),GC_30,MW,WW,W(1,6))
      CALL FFV5_3_S(W(1,2),W(1,4),GC_57,MW,WW,W(1,3))
C     Amplitude(s) for diagram number 1
      CALL VVT2_0(W(1,3),W(1,6),W(1,7),GC_16,AMP(1))
      CALL FFT4_5_2(W(1,2),W(1,7),GC_12,GC_13,ZERO,ZERO,W(1,3))
C     Amplitude(s) for diagram number 2
      CALL FFV5_0_S(W(1,3),W(1,4),W(1,6),GC_57,AMP(2))
      JAMP(1)=-AMP(1)-AMP(2)
      ...
      SUBROUTINE su_ud_s2(P,H1,H2,ANS)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     for the point in phase space P(0:3,NEXTERNAL)
C     
C     Process: s u > u d x QED<=99 NPqq<=99 NPll<=99 QCD<=99 NPgg<=99
C      NPvv<=99 @1
C     *   Decay: x > ta+ ta- WEIGHTED<=1
C     
      IMPLICIT NONE
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_su_ud_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_su_ud_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFT4_5_1(W(1,3),W(1,7),GC_12,GC_13,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 4
      CALL FFV5_0_S(W(1,1),W(1,8),W(1,5),GC_27,AMP(4))
