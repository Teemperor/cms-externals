      SUBROUTINE sxsx_s2(P,I3,I4,H1,H2,ANS)
      IMPLICIT NONE
C     
C     CONSTANT
C     
...
C     BEGIN CODE
C     ----------
      IF(I3.EQ.-3 .AND. I4.EQ.-3)CALL sxsx_sxsx_s2(P,H1,H2,ANS)

      END

      SUBROUTINE sxsx_sxsx_s2(P,H1,H2,ANS)
C     
...
C     ----------
      ...
      ANS = 0D0
      DO IHEL=1,NCOMB
            T=MATRIX_sxsx_sxsx_s2(P,H1,H2 ,NHEL(1,IHEL),JC(1))
            ANS=ANS+T
      ENDDO
      ANS=ANS/DBLE(IDEN)
      END
      ...
      REAL*8 FUNCTION MATRIX_sxsx_sxsx_s2(P,H1,H2,NHEL,IC)
C     
C     Generated by MadGraph5_aMC@NLO v. 2.4.3, 2016-08-01
C     By the MadGraph5_aMC@NLO Development Team
C     Visit launchpad.net/madgraph5 and amcatnlo.web.cern.ch
...
C     Amplitude(s) for diagram number 3
      ...
      CALL FFV5_6_3(W(1,3),W(1,1),GC_42,GC_39,MZ,WZ,W(1,9))
C     Amplitude(s) for diagram number 4
      CALL VVT2_0(W(1,5),W(1,9),W(1,7),GC_46,AMP(4))
C     Amplitude(s) for diagram number 5
      CALL VVT2_0(W(1,9),W(1,8),W(1,7),GC_48,AMP(5))
      CALL FFV4P0_3(W(1,3),W(1,2),GC_1,ZERO,ZERO,W(1,9))
      CALL FFV4P0_3(W(1,4),W(1,1),GC_1,ZERO,ZERO,W(1,8))
C     Amplitude(s) for diagram number 6
      CALL VVT2_0(W(1,9),W(1,8),W(1,7),GC_49,AMP(6))
      CALL FFV5_6_3(W(1,4),W(1,1),GC_42,GC_39,MZ,WZ,W(1,5))
...
C     Amplitude(s) for diagram number 8
      ...
      CALL FFV5_6_3(W(1,3),W(1,2),GC_42,GC_39,MZ,WZ,W(1,6))
