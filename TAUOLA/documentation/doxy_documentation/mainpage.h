...
- Note: LCG Generator Services Subproject provides compiled, platform adapted tar balls of our program versions 1.0.2-1.0.7.
  For newer versions only source code is available through Genser website. Tauola++ Genser distributions can be found
  <a href="http://service-spi.web.cern.ch/service-spi/external/MCGenerators/distribution/tauola++/">here</a>. 
...
For updates  with respect to release 1.0 see <a href="resources/TAUOLA.development.version/changelog.development.version.txt">changelog.txt</a>.
